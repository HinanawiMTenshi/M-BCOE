...
itc_staff      = itc_parry_polearm| itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback| itcf_overswing_spear |itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm
...
itc_guandao2    = itc_parry_polearm|itcf_thrust_onehanded_lance|itcf_overswing_polearm|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm

itc_guandao      = itc_parry_polearm|itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm | itcf_overswing_spear|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm

itc_lance      = itc_parry_polearm|itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm | itcf_overswing_spear|itcf_overswing_musket

itc_lance2      = itc_parry_polearm|itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm | itcf_overswing_polearm|itcf_overswing_musket

itc_greatlance = itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback| itcf_thrust_polearm

itc_guandao3      = itc_parry_polearm|itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm | itcf_overswing_spear|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm


itc_musket_melee = itc_parry_polearm|itcf_overswing_twohanded|itcf_thrust_musket|itcf_slashright_twohanded|itcf_slashleft_twohanded
#EXtra Mesh IDs
