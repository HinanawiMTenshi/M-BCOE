...
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_french_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_2,"trp_french_cuirassier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_2,"trp_french_carabineer_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_2,"trp_french_grenadier_a_cheval_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_french_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_2,"trp_french_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_2,"trp_french_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_2,"trp_french_infantry_ai"),
##challenges
...
##bosses
       ...
       (faction_set_slot,":faction"  ,slot_faction_boss_2,"trp_rhine_infantry_wurttemberg_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_2,"trp_rhine_uhlan_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_2,"trp_rhine_garde_du_corps_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_rhine_infantry_wurttemberg_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_2,"trp_rhine_infantry_saxony_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_2,"trp_rhine_infantry_wurttemberg2_ai"),
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_2,"trp_rhine_grenadier_guard_ai"),
       ...
       [
        ...
        (try_end),                    
         ...
         # (display_message, "@team2_living_players : {reg3}"),
          ...
          (store_mission_timer_b, "$g_invasion_timer_currenttime"),
          #(store_sub, ":time_difference",  "$g_invasion_timer_currenttime", "$g_invasion_timer_endwave"),
          #(store_sub,"$wave_start_time",30,":time_difference"),
      ...
      (1, 0, 0, [],
       [
        ...
        (try_begin),
            ...
            (try_end),
        (try_end),
        # (assign,reg2,"$wave_start_time"),
        # (display_message, "@wave_start_time : {reg2}"),
  ...
  ##Invasion: 
        ...
        # (display_message, "@g_invasion_timer_endwaver : {reg2}"),   
         ...
         # (display_message, "@score : {reg3}"),   
          ...
          (store_sub, ":time_difference",  "$g_invasion_timer_currenttime", "$g_invasion_timer_endwave"),
          #(assign,"$wave_start_time",":time_difference"),
         # (assign,  reg2,":time_difference"),
         # (display_message, "@time_difference : {reg2}"),
...
##Start Wave system#
        ...
        (try_for_range, ":num_wave", 1, ":num_waves"), #Waves!
          ...
          (try_for_range, ":unused", 0, ":bots"), #Spawns the bots, is different for bosses and challenges
            ...
            (add_visitors_to_current_scene,":spawn",":boss_minion1",8, ":invader_team", ":selected_group"),
          # (else_try),
