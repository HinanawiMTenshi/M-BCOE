...
######################### ilam added begin ################################
###########################################################################
multiplayer_cb_deal_sailor_or_marine = (
    ti_on_agent_spawn, 0, 0, [(eq, "$g_multiplayer_game_type", multiplayer_game_type_commander),],
    [
    (store_trigger_param_1, ":agent"),
    (agent_is_non_player, ":agent"),
    (agent_is_active, ":agent"),
    (agent_get_group, ":belonged_player", ":agent"),
    (player_is_active, ":belonged_player"),
    (agent_get_troop_id, ":tp", ":agent"),
    (player_get_troop_id, ":ptp", ":belonged_player"),
    (gt,":ptp",-1),
...
multilplayer_v15_2_thunder_light = (1,0, 0,
  [
...
multilplayer_v15_2_thunder_light_2 =	(0, 0, 0, 
  [
		(neg|multiplayer_is_dedicated_server),
  ], 
  [
...
multiplayer_client_drowning_v15 = (   # Drowning and wet powder script
  1.1, 0, 0, [],
  [
    (set_fixed_point_multiplier, 100),
    (get_player_agent_no, ":cur_agent"),
    (try_begin),
      ...
      (agent_get_slot, ":underwater_time", ":cur_agent", slot_agent_underwater_time_client),
      ...
      (try_begin),
        ...
        (try_begin),
            (agent_slot_eq,":cur_agent",slot_agent_underwater_now_client,0),
            (agent_set_slot, ":cur_agent", slot_agent_underwater_now_client, 1),
        (try_end),
        (try_begin),
          (lt, ":underwater_time", 1),
          (agent_set_slot, ":cur_agent", slot_agent_underwater_time_client, 0),
		(else_try),
		  (agent_set_slot, ":cur_agent", slot_agent_underwater_time_client, ":underwater_time"),
        (try_end),
        
      (else_try),#coming up
        (lt, ":underwater_time", 8),   
        (try_begin),
          (agent_slot_eq,":cur_agent",slot_agent_underwater_now_client,1),
          (agent_set_slot, ":cur_agent", slot_agent_underwater_now_client, 0),
        (try_end),        
        (val_add, ":underwater_time", 4),
		(try_begin),
			(gt, ":underwater_time", 8),
			(assign, ":underwater_time", 8),
		(try_end),
        (agent_set_slot, ":cur_agent", slot_agent_underwater_time_client, ":underwater_time"),
      (try_end),
    (try_end),
...
multiplayer_v15_2_reset_on_agent_killed = (
  ti_on_agent_killed_or_wounded, 0, 0, [(eq, "$display_kill_death_info_val", 1),],
  [ 
            ...
            (this_or_next|eq, ":killer", ":my_agent"),
            (eq, ":victim", ":my_agent"),	

            (assign, "$slay_suicide_display", 0),
                
            (agent_get_team, ":0_team", ":victim"),
            (agent_get_team, ":1_team", ":killer"),	
            ...
            (try_begin),
                ...
                (try_begin),
                    (eq, ":killer", ":my_agent"),
                    (start_presentation, "prsnt_multiplayer_v15_kill_info_tk_reminder"),
                (else_try),
                    (assign, "$slay_suicide_display", 4),
                (try_end),
            (try_end),
            
            (try_begin),#if is suicide
                (eq, ":killer", ":my_agent"),
                (eq, ":victim", ":my_agent"),
                (assign, "$slay_suicide_display", 1),
                (try_begin),
                    (agent_slot_eq, ":my_agent", slot_agent_underwater_now_client, 1),
                    (agent_slot_eq, ":my_agent", slot_agent_underwater_time_client, 0),
                    (assign, "$slay_suicide_display", 2),
                (try_end),
                (start_presentation, "prsnt_multiplayer_death_info_display"),#admin kill is suicide, but have to seperate it
            (else_try),
                (eq, ":killer", ":my_agent"),
                (neq, ":victim", ":my_agent"),
                (try_begin),
                    (neg|agent_is_non_player, ":victim"),
                    (agent_get_player_id, ":player_id", ":victim"),
                    (str_store_player_username, s10, ":player_id"),
                (else_try),
                    (agent_is_non_player, ":victim"),
                    (agent_get_troop_id, ":troop", ":victim"),
                    (str_store_troop_name, s10, ":troop"),
                (try_end),
                (start_presentation, "prsnt_multiplayer_killing_info_display"),
            (else_try),
                (neq, ":killer", ":my_agent"),
                (eq, ":victim", ":my_agent"),
                (try_begin),
                    (neg|agent_is_non_player, ":killer"),
                    (agent_get_player_id, ":player_id", ":killer"),
                    ...
                    (try_begin),
                        ...
                        (assign, ":continue", 1),
                    (else_try),
                        (ton|eq, ":0_team", ":1_team"),
                        (neq, ":0_team", ":1_team"),
                        (ton|eq, "$g_multiplayer_game_type", multiplayer_game_type_duel),
                        (eq, "$g_multiplayer_game_type", multiplayer_game_type_deathmatch),
                        (assign, ":continue", 1),
                    (try_end),      
                    (eq, ":continue", 1),
                    (agent_get_troop_id, ":troop", ":killer"),
                    (str_store_troop_name, s12, ":troop"),
                    (str_store_troop_name_plural, s13, ":troop"),
                    (start_presentation, "prsnt_multiplayer_kdinfo_troop"),
                (else_try),
                    (agent_is_non_player, ":killer"),
                    (agent_get_troop_id, ":troop", ":killer"),
                    (str_store_troop_name, s11, ":troop"),
                (else_try),
                    (neg|agent_is_human, ":killer"),
                    (agent_get_item_id, ":i", ":killer"),
                    (str_store_item_name, s11, ":i"),
                    (assign, "$slay_suicide_display", 3),
                (try_end),
                (start_presentation, "prsnt_multiplayer_death_info_display"),
            (try_end),	  
  ])

multiplayer_v15_open_battlemap = (
  0, 0.1, 0, [
			(neg|multiplayer_is_dedicated_server),
            (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
            (eq, "$display_minimap_proj_val", 0),
			(key_clicked, key_m),
  ],
  [
		(assign, "$display_minimap_proj_val", 1),
        (start_presentation, "prsnt_multiplayer_minimap"),
	
    ])

	
multiplayer_v15_display_ally_namne = (
  0, 0.1, 0, [
			(neg|multiplayer_is_dedicated_server),
  ...
  [
	(try_begin),	
		(eq, "$display_ally_name_proj_val", 1),
		(assign, "$display_ally_name_proj_val", 0),
	(else_try),
		(eq, "$display_ally_name_proj_val", 0),
		(assign, "$display_ally_name_proj_val", 1),
        (start_presentation, "prsnt_multiplayer_display_hp_bar_name"),
	(try_end),
...
#multiplayer_v15_key_to_zoom = (
 # 0, 0, 0, 
  #[
	#(key_is_down, key_v),
	#(neg|is_presentation_active, "prsnt_spyglass_dummy"),
	#(neg|is_presentation_active, "prsnt_key_to_zoom"),
	#(neg|multiplayer_is_dedicated_server),
  #],
  #[ 
	#(start_presentation, "prsnt_key_to_zoom"),
  #])
  
  #Salute
# multiplayer_client_baoquan = (
  # 0, 0, 0, [
  # (neg|multiplayer_is_dedicated_server),
  # (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
...
# (agent_set_animation ,":player_agent","anim_baoquan",1 ),
# (else_try),
# (agent_set_animation ,":player_agent","anim_baoquan",1 ),
# (try_end),
...
# dedal_shield_taunt = (0, 0, 0, [
    ...
    # (call_script,"script_shield_taunt_trigger")
      ...
      # (try_for_agents,":agent"),
        ...
        # (multiplayer_send_int_to_server,multiplayer_event_send_player_action, me_agent_shield_taunt),
      # (try_end),
...
wuqiang = (0, 0, 1, [
    (neg|multiplayer_is_dedicated_server),
    (game_key_clicked,gk_view_char),#####block movement? change key?
    (game_key_is_down,gk_defend),
    ],[
    #(call_script,"script_shield_taunt_trigger")
      ...
      (try_begin),
        ...
        # (agent_get_horse,":horse",":agent"),
        # (eq,":horse",-1),#not on horse
        (multiplayer_send_int_to_server,multiplayer_event_send_player_action, player_action_wuqiang ),
      (try_end),
    
    ])
  
multiplayer_v15_reset_on_mission_end = (
  ti_on_multiplayer_mission_end, 0, 0, 
  [
  ],
  [ 
	(troop_set_slot, "trp_companion_2", slot_troop_name_for_tab_list, 0),
  ])
...
0.25, 0, 0, [(this_or_next|multiplayer_is_server),(neg|game_in_multiplayer_mode),],
  [  
    (try_for_prop_instances, ":instance_id"),
      ...
      (store_div,":deg_value2",":height_difference",800),  # 120 is distance between the two wheels.
      ...
      (try_begin),
        (lt,":deg_value",0),
        (val_mul,":deg_value",100), # 108 %
        (val_div,":deg_value",100),
      (else_try),
        (gt,":deg_value",0),
        (val_mul,":deg_value",100), # 92 %
        (val_div,":deg_value",100),
      (try_end),
...
multiplayer_server_drag_cart2 = (
0.25, 0, 0, [(this_or_next|multiplayer_is_server),(neg|game_in_multiplayer_mode),],
  [  
    (try_for_prop_instances, ":instance_id", "spr_mm_limber_wood", somt_temporary_object),
    #(try_for_prop_instances, ":instance_id"),
    
      #(ton|eq,":instance_id","spr_pw_cart_a_wheels"),
      #(eq,":instance_id","spr_pw_cart_a"),
...
multiplayer_client_voicecommands = (
  ...
  [
    ...
    (else_try),
      ...
      (val_add,":wait_time",0), # add two due to lag...  changed to 5.
      ...
      (else_try),
        ...
        (assign, ":voice_type", voice_type_comm_inf),
      (else_try),
        (game_key_clicked, gk_archers_hear),
        (assign, ":voice_type", voice_type_comm_skr),
      (else_try),
        (game_key_clicked, gk_cavalry_hear),
        (assign, ":voice_type", voice_type_comm_cav),
      (else_try),
        (game_key_clicked, gk_group3_hear),         
        (assign, ":voice_type", voice_type_comm_unit),
      (else_try),
        (game_key_clicked, gk_everyone_hear),
        (assign, ":voice_type", voice_type_comm_every),
        #TEST
  ...
  [
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (else_try),
          (eq, ":order", mordr_all_fire_now),
          (assign, ":voice_type", voice_type_comm_fire),
        (else_try),
          (eq, ":order", mordr_left_fire_now),
          (assign, ":voice_type", voice_type_comm_fire_left),
        (else_try),
          (eq, ":order", mordr_middle_fire_now),
          (assign, ":voice_type", voice_type_comm_fire_middle),
        (else_try),
          (eq, ":order", mordr_right_fire_now),
          (assign, ":voice_type", voice_type_comm_fire_right),
        (else_try),
        ...
        (else_try),
          (eq, ":order", mordr_mount),
          (assign, ":voice_type", voice_type_comm_mount),
        (else_try),
          (eq, ":order", mordr_dismount),
          (assign, ":voice_type", voice_type_comm_dismount),
        (else_try),
          (eq, ":order", mordr_stand_closer),
          (assign, ":voice_type", voice_type_comm_closer),
        (else_try),
          (eq, ":order", mordr_spread_out),
          (assign, ":voice_type", voice_type_comm_spread),
        (else_try),
          (eq, ":order", mordr_use_any_weapon),
          (assign, ":voice_type", voice_type_comm_any),
        (else_try),
          (eq, ":order", mordr_form_1_row),
          (assign, ":voice_type", voice_type_comm_1),
        (else_try),
          (eq, ":order", mordr_form_2_row),
          (assign, ":voice_type", voice_type_comm_2),
        (else_try),
          (eq, ":order", mordr_form_3_row),
          (assign, ":voice_type", voice_type_comm_3),
        (else_try),
          (eq, ":order", mordr_form_4_row),
          (assign, ":voice_type", voice_type_comm_4),
        (else_try),
          (eq, ":order", mordr_form_5_row),
          (assign, ":voice_type", voice_type_comm_5),
        (else_try),
          (eq, ":order", mordr_hold_fire),
          (assign, ":voice_type", voice_type_comm_hold_fire),
        (else_try),
          (eq, ":order", mordr_use_melee_weapons),
          (assign, ":voice_type", voice_type_comm_melee),
        (else_try),
          (eq, ":order", mordr_hold_fire),
          (assign, ":voice_type", voice_type_comm_hold_fire),
        (else_try),
          (eq, ":order", mordr_use_ranged_weapons),
          (assign, ":voice_type", voice_type_comm_ranged_weapons),
        (else_try),
          (eq, ":order", mordr_retreat),
          (assign, ":voice_type", voice_type_comm_retreat),
        (else_try),
          (eq, ":order", mordr_stand_ground),
          (assign, ":voice_type", voice_type_comm_stand_ground),
        (else_try),
          (eq, ":order", mordr_use_blunt_weapons),
          (assign, ":voice_type", voice_type_comm_blunt),
        (try_end),
      ...
      (try_for_prop_instances, ":ball_instance_id", ":cannonball_type", somt_temporary_object),
        ...
        (try_for_agents, ":cur_agent",pos35,":check_range"),
          ...
          (try_begin),
            ...
            (call_script, "script_clean_up_prop_instance", ":ball_instance_id"), # clean up ball
            (assign, ":check_agents", 0),
			#(agent_get_player_id, ":user_player", ":user_agent"),
          (else_try),
            (eq,":ammo_type",cannon_ammo_type_round),
...
pistol_rerload = (
  ...
  [ 
    (get_player_agent_no,":agent"),
    (call_script,"script_multiplayer_server_play_sound_at_agent", "snd_reload_pistol",":agent" ),
  ])

suicide_pistol_sound = (
  0.1, 2, 2, [
  (neg|multiplayer_is_dedicated_server),
  ],
  [ 
  (try_for_agents,":agent"),
    ...
    (eq,":anim","anim_shouqiangzisha"),
    (get_player_agent_no,":agent"),
    (call_script,"script_multiplayer_server_play_sound_at_agent", "snd_pistol",":agent" ),
  (try_end),
  ...
  0.1, 0, 0, [(neg|multiplayer_is_dedicated_server),],
   [
    (try_for_agents,":agent_id"),
        (try_begin),
            (ton|agent_has_item_equipped,":agent_id","itm_heavy_matchlock"),
            (ton|agent_has_item_equipped,":agent_id","itm_heavy_matchlock2"),
            (agent_has_item_equipped,":agent_id","itm_pishaw_musket"),
            (agent_get_wielded_item,":item",":agent_id",0),
            (try_begin),
                (neg|agent_has_item_equipped,":agent_id","itm_badish_tomahawk"),
                (neg|agent_has_item_equipped,":agent_id","itm_berdish"),
                (ton|eq,":item","itm_heavy_matchlock2"),
                (ton|eq,":item","itm_heavy_matchlock"),
                (eq,":item","itm_pishaw_musket"),
                (call_script,"script_forkiet",":agent_id"),
            (else_try),
                (agent_has_item_equipped,":agent_id","itm_officer_gloves2"),
                (ton|neq,":item","itm_pishaw_musket"),
                (ton|neq,":item","itm_heavy_matchlock2"),
                (neq,":item","itm_heavy_matchlock"),
                (call_script,"script_remove_forkiet",":agent_id"),
            (else_try),
                (neg|agent_has_item_equipped,":agent_id","itm_badish_tomahawk"),
                (agent_has_item_equipped,":agent_id","itm_berdish"),
                (ton|eq,":item","itm_heavy_matchlock2"),
                (ton|eq,":item","itm_heavy_matchlock"),
                (eq,":item","itm_pishaw_musket"),
                (call_script,"script_forkiet_axe",":agent_id"),
            (else_try),
                (agent_has_item_equipped,":agent_id","itm_long_axe_frame_gun"),
                (ton|neq,":item","itm_heavy_matchlock2"),
                (ton|neq,":item","itm_heavy_matchlock"),
                (neq,":item","itm_pishaw_musket"),
                (call_script,"script_remove_axe",":agent_id"),
            (else_try),
                (agent_has_item_equipped,":agent_id","itm_badish_tomahawk"),
                (ton|eq,":item","itm_heavy_matchlock2"),
                (ton|eq,":item","itm_heavy_matchlock"),
                (eq,":item","itm_pishaw_musket"),
                (call_script,"script_forkiet_axe_guard",":agent_id"),
            (else_try),
                (agent_has_item_equipped,":agent_id","itm_long_axe_frame_gun_guard"),
                (ton|neq,":item","itm_heavy_matchlock2"),
                (ton|neq,":item","itm_heavy_matchlock"),
                (neq,":item","itm_pishaw_musket"),
                (call_script,"script_remove_axe_guard",":agent_id"),
                
            (try_end),
        (else_try),
            (try_begin),
                (agent_has_item_equipped,":agent_id","itm_long_axe_frame_gun"),
                (ton|neg|agent_has_item_equipped,":agent_id","itm_heavy_matchlock"),
                (ton|neg|agent_has_item_equipped,":agent_id","itm_pishaw_musket"),
                (neg|agent_has_item_equipped,":agent_id","itm_heavy_matchlock2"),
                (call_script,"script_remove_axe",":agent_id"),
            (else_try),
                (agent_has_item_equipped,":agent_id","itm_officer_gloves2"),
                (ton|neg|agent_has_item_equipped,":agent_id","itm_heavy_matchlock"),
...
heavy_musket_aimming = (
    0, 0, 0, 
    [(neg|multiplayer_is_dedicated_server),],
    [
    #(try_for_agents, ":player_agent"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_set_speed_zero),
    #(try_end),
    ],	 
       )
  ...
  ti_on_agent_hit, 0, 0,
    ...
    [
        ...
        (try_begin),
            ...
            (assign, ":item", reg0),
            (ton|eq,":item","itm_lance_3"),
            (ton|eq,":item","itm_cavalry_lance_b"),
            (ton|eq,":item","itm_winged_hassur_lance"),
            (eq,":item","itm_osman_lance"),
            (call_script,"script_lance_broken",":attacker",":item"),
        (try_end),
    ])
...
suicide_action = (
  ...
  (eq,":horse",-1),
    ...
    (ton|eq,":agent_faction","fac_britain"),
    (eq,":agent_faction","fac_british_ranks"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_suicide_m),
    (try_end),
    ],	
...
suicide_action_jin = (
  ...
  (eq,":horse",-1),
    ...
    (agent_get_troop_id, ":agent_troop_id", ":player_agent"),
    (store_troop_faction, ":agent_faction", ":agent_troop_id"),
    (ton|eq,":agent_faction","fac_russia"),
    (eq,":agent_faction","fac_russian_ranks"),
    (agent_get_horse,":horse",":player_agent"),
    (eq,":horse",-1),#not on horse
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_suicide_jin),
    (try_end),
    ],	
...
suicide_action_jap = (
  ...
  (eq,":horse",-1),
    ...
    (agent_get_troop_id, ":agent_troop_id", ":player_agent"),
    (store_troop_faction, ":agent_faction", ":agent_troop_id"),
    (ton|eq,":agent_faction","fac_france"),
    (eq,":agent_faction","fac_french_ranks"),
    (agent_get_horse,":horse",":player_agent"),
    (eq,":horse",-1),#not on horse
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_suicide_j),
    (try_end),
    ],	
...
suicide_action_spa = (
  ...
  (eq,":horse",-1),
    ...
    (agent_get_troop_id, ":agent_troop_id", ":player_agent"),
    (store_troop_faction, ":agent_faction", ":agent_troop_id"),
    (ton|eq,":agent_faction","fac_prussia"),
    (eq,":agent_faction","fac_prussian_ranks"),
    # (agent_play_sound, ":player_agent", "snd_pistol"),

#muzzle
    # (position_move_x,pos41,-16),
    # (position_move_y,pos41,18),
    # (particle_system_burst_no_sync, "psys_pan_smoke", pos41, 8),
    # (particle_system_burst_no_sync, "psys_pan_flash", pos41, 1),      
    # (position_rotate_z,pos41,0),
    # (position_move_y,pos41,0),
    # (particle_system_burst_no_sync, "psys_musket_smoke", pos41, 17),
    # (particle_system_burst_no_sync, "psys_musket_flash", pos41, 1),
    (agent_get_horse,":horse",":player_agent"),
    (eq,":horse",-1),#not on horse
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_suicide_s),
    (try_end),
    ],	
...
##Call horse
call_horse_trigger = (0, 0, 0, [(key_clicked, key_h)], [
      #(get_player_agent_no,":agent"),
      # (agent_get_horse,":horse",":agent"),
      # (neg|gt,":horse",0),
      (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_call_horse),
    ])
       
init_player_horse = (ti_on_agent_spawn, 0.5, 0, [], [
        (store_trigger_param_1,":agent"),
        ...
        (agent_is_active,":rider"),
        (agent_is_alive,":rider"),
        (agent_set_slot,":agent",slot_agent_horse,":rider"),
    ])
       ...
       [
        (try_begin),
            (try_for_agents,":player_agent"),
                ...
                (agent_is_active,":player_agent"),
            (agent_get_slot, ":fangun_cd", ":player_agent", slot_agent_roll_time),
            (gt, ":fangun_cd", 0),
            (val_sub,":fangun_cd",1),
            (agent_set_slot, ":player_agent", slot_agent_roll_time, ":fangun_cd"),
        (try_end),
     ])

# rolling_action = ( 0, 0, 0, [
    # (try_for_agents,":agent"),
        # (agent_is_alive,":agent"),
        # (agent_is_human,":agent"),
        # (agent_is_active,":agent"),
        # (agent_get_troop_id, ":troop", ":agent"),
        # (neq,":troop","trp_french_carabineer"),
    # (try_end),
# ],
       # [
        ...
        # (try_begin),
            ...
            # (agent_get_slot, ":fangun_cd", ":player_agent", slot_agent_roll_time),
             ...
             # (try_begin),
               ...
               # (call_script,"script_rolling_f",":player_agent"),
               # (play_sound, "snd_tc_fangun"),
               # (agent_set_animation,":player_agent","anim_fangun_forward"),
               # (agent_set_slot, ":player_agent", slot_agent_roll_time, 5),
             # (else_try),
               # (game_key_is_down, gk_move_backward),
               # (key_clicked, key_left_alt),
               # (call_script,"script_rolling_b",":player_agent"),
               # (play_sound, "snd_tc_fangun"),
             ...
             # (else_try),
               ...
               # (key_clicked, key_left_alt),
               # (call_script,"script_rolling_l",":player_agent"),
               # (play_sound, "snd_tc_fangun"),
             ...
             # (else_try),
               ...
               # (key_clicked, key_left_alt),
               # (call_script,"script_rolling_r",":player_agent"),
               # (play_sound, "snd_tc_fangun"),
...
rolling_f = (
  ...
  (agent_get_horse,":horse",":agent"),
  (eq,":horse",-1),
  (agent_get_slot, ":fangun_cd", ":agent", slot_agent_roll_time),
  (le,":fangun_cd",0),
  ],
  [
    #(get_player_agent_no,":agent"),
    #(call_script,"script_cf_rolling",":agent"),
  # (agent_get_slot, ":fangun_cd", ":agent", slot_agent_roll_time),
  # (le,":fangun_cd",0),
    (get_player_agent_no,":agent"),
   (call_script,"script_cf_rolling",":agent"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_rolling_f),
  ])
...
rolling_b = (
  ...
  [
    (get_player_agent_no,":agent"),
   (call_script,"script_cf_rolling",":agent"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_rolling_b),
  ])
...
rolling_l = (
  ...
  [
    (get_player_agent_no,":agent"),
   (call_script,"script_cf_rolling",":agent"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_rolling_l),
  ])
...
rolling_r = (
  ...
  [
    (get_player_agent_no,":agent"),
   (call_script,"script_cf_rolling",":agent"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_rolling_r),
  ])
...
bow_spear = (
  ...
  (get_player_agent_no,":agent"),
  (key_clicked,key_x),
  (neg|is_presentation_active, "prsnt_multiplayer_escape_menu"),#确定你不在管理面板
  (neg|is_presentation_active, "prsnt_game_multiplayer_admin_panel"),
  (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
  (neg|is_presentation_active, "prsnt_multiplayer_custom_chat"),
  (agent_get_horse,":horse",":agent"),
  (eq,":horse",-1),  ],
   [
    ...
    (agent_is_alive, ":agent_id"),
    (ton|agent_has_item_equipped,":agent_id","itm_yumi_spear"),
    (agent_has_item_equipped,":agent_id","itm_yumi_spear_melee"),
    (agent_get_wielded_item,":wielded_item",":agent_id",0),
    (ton|eq,":wielded_item","itm_yumi_spear"),
    (eq,":wielded_item","itm_yumi_spear_melee"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_spear),
    #(call_script, "script_bomb_ignited",":agent_id"),
    ],)
...
ignite_bomb = (
  ...
  (eq,":horse",-1),  ],
   [
    ...
    (player_get_agent_id, ":agent_id", ":my_player"),
    (agent_is_alive, ":agent_id"),
    (agent_has_item_equipped,":agent_id","itm_bomb_small"),
    (agent_get_wielded_item,":wielded_item",":agent_id",0),
    (eq,":wielded_item","itm_bomb_small"),
    (store_mission_timer_a, ":current_time"),
    (call_script,"script_cf_explosion",":agent_id",":current_time"),
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_fuse),
    #(call_script, "script_bomb_ignited",":agent_id"),
    ],)


#如果你死了，你身上有手雷，会在你尸体上爆炸
explode_in_dead_body = (
  ti_on_agent_killed_or_wounded, 0, 0, 
  [
  (store_trigger_param_1,":agent"),
  (agent_has_item_equipped,":agent","itm_bomb_small_ignited"),
  ],
   [
   (store_trigger_param_1,":agent"),
   (call_script,"script_cf_explosion_pack",":agent"),#锁定你死亡的位置为爆炸位置
    ],)
#如果你按G丢弃了点燃的雷，也会炸
drop_grenade_on_ground = (
  ti_on_item_dropped, 0, 0, 
  [
  (store_trigger_param_2,":item"),
  (eq,":item","itm_bomb_small_ignited"),
  ],
   [
   (store_trigger_param_1,":agent"),
    (call_script,"script_cf_explosion_pack",":agent"),#锁定你丢弃的位置为爆炸位置
    ],)
#如果你丢出去了，你就不会炸
bomb_throwed = (
  0, 0, 0, 
   ...
   [
    (try_for_agents,":agent_id"),
        (try_for_range, ":item_slot", 0, 4), 
            ...
            (eq, ":item","itm_bomb_small_ignited"),
            (agent_get_ammo_for_slot, ":ammo", ":agent_id" , ":item_slot"),
            (eq,":ammo",0), 
            (agent_set_slot, ":agent_id", slot_drop_bomb_ignite_time, -1),   
        (try_end),
    (try_end),
    ],)

#最终爆炸判断触发器，会检测你是不是装备了点燃的手雷，到时间了就起爆
drop_grenade_on_ground_check = (
  0, 0, 0, 
  [],
   [
   (try_for_agents,":agent_id"),
   (agent_is_human,":agent_id"),
   (agent_get_slot, ":explode_time",":agent_id", slot_drop_bomb_ignite_time ),
        (try_for_range, ":item_slot", 0, 4), 
            (agent_get_item_slot, ":item", ":agent_id",":item_slot"),
            (eq, ":item","itm_bomb_small_ignited"), 
            (agent_get_ammo_for_slot, ":ammo", ":agent_id" , ":item_slot"),
            (eq,":ammo",1), 
            (call_script,"script_cf_explosion_pack",":agent_id"), 
        (try_end),
   (eq,":explode_time",1),   
   (neq,":explode_time",-1),   
    (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_exp),
    (call_script,"script_cf_explosion_pos_store",":agent_id"),
    (agent_set_slot, ":agent_id", slot_drop_bomb_ignite_time, -1),
   (try_end),
    ],)
       ...
       [
        (try_begin),
            (try_for_agents,":player_agent"),
                ...
                (agent_is_alive,":player_agent"),
                (agent_is_active,":player_agent"),
            (agent_get_slot, ":explode_time",":player_agent", slot_drop_bomb_ignite_time ),
            (val_sub,":explode_time",1),
            (agent_set_slot, ":player_agent", slot_drop_bomb_ignite_time, ":explode_time"),
            # (assign,reg3,":explode_time"),
            # (display_message, "@time: {reg3}"),
        (try_end),
     ])
       ...
       [
        (try_begin),
            (try_for_agents,":player_agent"),
                (agent_is_human,":player_agent"),
                (agent_is_active,":player_agent"),
                (agent_get_wielded_item,":item",":player_agent"),
                (eq,":item","itm_ming_sanyanchong_q"),
                (agent_get_slot, ":yes", ":player_agent", slot_sanyanchong_fire),
                (eq,":yes",1),
                #(multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_sanyanchong),
                (agent_get_look_position,pos23,":player_agent"),
                (agent_get_bone_position, pos24, ":player_agent", 9, 1),
                (position_move_z, pos24, 30, 1),
                (position_copy_rotation,pos24,pos23),
                (try_for_range,":slot",0,4),
                    (agent_get_item_slot, ":item_no", ":player_agent", ":slot"),
                    (eq,":item_no","itm_ming_sanyanchong_q"),
                    (assign,":correct_slot",":slot"),
                (try_end),
                
                (agent_get_item_cur_ammo, ":cur_ammo", ":player_agent",":correct_slot"),
                (try_begin),
                (gt,":cur_ammo",0),
                    (add_missile, ":player_agent", pos24, 12000, "itm_ming_sanyanchong_q", 0, "itm_bullets_invisible",0),
                    (val_sub,":cur_ammo",1),
                    (agent_set_ammo,":player_agent",":item",":cur_ammo"),
                (else_try),
                    (eq,":cur_ammo",0),
                    (agent_set_slot,":player_agent", slot_sanyanchong_fire,0),
                (try_end),
            (try_end),
        (try_end),
     ])
...
sanyanchong_timer = (
    ...
    (try_for_agents,":player_agent"),
        (try_begin),
            (agent_is_human,":player_agent"),
            (agent_get_slot, ":time", ":player_agent", slot_sanyanchong_time),
            (val_sub,":time",0.1),
            (agent_set_slot,":player_agent", slot_sanyanchong_time,":time"),
        (try_end),
    (try_end),
     ])
...
automatic_fire = (
   ...
   [
    ...
    (try_for_agents,":attacker_agent"),
      ...
      (ton|eq,":agent_cur_weapon","itm_xunleichong"),
      (eq,":agent_cur_weapon","itm_gatling"),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            (eq,":agent_cur_weapon","itm_gatling"),
            (store_div,":ticker_time",4,":ticker_time"),
            (agent_set_slot,":attacker_agent",slot_agent_shoot_time_ticker,":ticker_time"),
          (try_end),
          ...
          (assign,":killed",1),
          (try_begin),
            (eq,":agent_cur_weapon","itm_xunleichong"),
            (assign,":killed",1),
          (try_end),
          ...
          (try_begin),
             (try_begin),
                (eq,":agent_cur_weapon","itm_xunleichong"),
                (agent_set_animation, ":attacker_agent", "anim_release_throwing_knife", 1),
             (else_try),
                (eq,":agent_cur_weapon","itm_gatling"),
                (agent_set_animation, ":attacker_agent", "anim_release_gatling", 1),
             (try_end),
             (try_begin),
               (le,":bullet_speed",0),
               (assign,":bullet_speed",150),
          ...
          (try_for_range, ":unused", 0, ":killed"),
            ...
            (add_missile, ":attacker_agent", pos25, ":bullet_speed", ":agent_cur_weapon", 0, "itm_bullets_invisible",0),
          (try_end),
        (else_try),
       ...
       [
        (try_begin),
            (try_for_agents,":player_agent"),
                ...
                (agent_is_human,":player_agent"),
                (agent_is_active,":player_agent"),
            (agent_get_slot, ":st_cd", ":player_agent", slot_agent_shield_time),
            (gt, ":st_cd", 0),
            (val_sub,":st_cd",1),
            (agent_set_slot, ":player_agent", slot_agent_shield_time, ":st_cd"),
        (try_end),
     ])


shield_init = (ti_before_mission_start, 0, 0, [], [(assign,"$bash_readiness",0)])


shield_init2 = (0.1, 0, 0, [], [(val_add,"$bash_readiness",1),])


shield_hit = (0, 0, 0, [(game_key_is_down, gk_defend),(key_clicked, key_left_control),],
       [(assign,":continue",0),
       
        (get_player_agent_no,":player"),
        (agent_get_slot, ":st_cd", ":player", slot_agent_shield_time),
        (agent_is_alive,":player"),
        (try_for_range,":shield","itm_ming_shield","itm_key"),
        ...
        (le,":st_cd",0),
        (call_script,"script_cf_shield_hit",":player"),
        (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_st),
        ])
...
shield_hit2 =       (1.0, 0, 0, [],
       [(get_player_agent_no,":player"),
        (try_for_agents,":agent"),
           ...
           (lt,":rand",":chances"),
            (call_script,"script_cf_shield_hit",":agent"),
            (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_st),
        (end_try),])
...
multiplayer_client_walking = (
  ...
  [
    ...
    (else_try),
	  ...
	  #v15
	#  (agent_get_slot, ":slot_num", ":agent_id", slot_agent_in_walk),
	#  (try_begin),
	#	(eq, ":slot_num", 0),
	#	(agent_set_slot, ":agent_id", slot_agent_in_walk, 1),
	#  (else_try),
	#	(agent_set_slot, ":agent_id", slot_agent_in_walk, 0),
    #  (try_end),
...
multiplayer_client_custom_action_v = (
  ...
  (eq,":horse",-1),
    (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_key_v,music_type_start),
...
# multiplayer_client_custom_action_back_space = (
  # 0, 0, 1.0, [
  # (neg|multiplayer_is_dedicated_server),
  # (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),
  # (neg|is_presentation_active, "prsnt_multiplayer_custom_chat"),
  ...
  # ],
  # [
    # (multiplayer_send_int_to_server,multiplayer_event_send_player_action,player_action_key_back_space),
  # ])
...
multiplayer_server_move_bird_common = (
  ...
  [
    ...
    #(try_for_prop_instances, ":bird_id", "spr_mm_bird"),
      ...
      (prop_instance_deform_in_cycle_loop, ":bird_id", 1, 9, 2790),
...
multiplayer_thunder_lightning_client = (
  0, 0.12, 0.03, [(neg|multiplayer_is_dedicated_server),(eq, "$g_thunder_state", 1),],#(is_between,"$g_thunder_state",1, 3),], #Client side thunder storm lightning check
  [
  ...
  [
    ...
    (try_for_range, ":cur_loop", 0, ":loop_count"),# 50 #"$g_rain_amount" / 10
      ...
      (try_begin),
        ...
        (particle_system_burst_no_sync, "psys_v15_rain_drop", pos19, 1),
      (else_try),
...
multiplayer_server_spawn_bots = (
  ...
  [
   ...
   ##tBfC##
      ...
      (try_begin),
        (ton|eq, "$g_multiplayer_game_type", multiplayer_game_type_royale),
        (eq, "$g_multiplayer_game_type", multiplayer_game_type_battle),
...
multiplayer_server_check_end_map = ( 
  ...
  [
   ...
   ##tBfC##
    ...
    ##tBfC##    
      #(neq, "$g_multiplayer_game_type", multiplayer_game_type_royale), #battle mod has different end map condition by time
    ##tBfC##
  ...
  ##Zhengde
        # (else_try),
          ...
          # (eq, "$g_multiplayer_game_type", multiplayer_game_type_royale),
          # (ge, ":team_1_score", "$g_multiplayer_game_max_points"),
          # (assign, ":end_map", 1),
  ##Zhengde    
        (try_end),
        # Vincenzo end
...
##Zhengde    
	...
	# ilam v15
    (try_begin),
        (gt, "$display_minimap_proj_val", 0),
        (try_begin),
            (eq, "$display_minimap_proj_val", 2),
            (assign, "$display_minimap_proj_val", 1),
        (try_end),
		(start_presentation, "prsnt_multiplayer_minimap"),
    (try_end),
	(try_begin),
		(eq, "$g_multiplayer_game_type", multiplayer_game_type_commander),
		(eq, "$display_cb_troop_ratio_val", 1),
		(start_presentation, "prsnt_multiplayer_commander_battle_troop_ratio"),
	(try_end),
	...
	(start_presentation, "prsnt_multiplayer_character_status_icon_display"),
    (try_begin),
        (eq, "$display_server_info_lat_val", 1),
        (start_presentation, "prsnt_multiplayer_server_info_latency_display"),
    (try_end),
    (try_begin),
        (eq, "$display_hp_bar_val", 1),
        (start_presentation, "prsnt_multiplayer_v15_hp_bar"),
    (try_end),
...
common_battle_init_banner = (
  ...
  [
	...
	(try_begin),
		...
		(agent_set_slot, ":my_agent", slot_agent_underwater_time_client, 8),
		(agent_set_slot,":my_agent",slot_agent_underwater_now_client,0),
	(try_end),
...
mm_multiplayer_common = [
  # v15
  multilplayer_v15_2_thunder_light,
  multilplayer_v15_2_thunder_light_2,
  multiplayer_v15_open_battlemap,
  multiplayer_v15_2_reset_on_agent_killed,
  

  multiplayer_client_drowning_v15,
  #multiplayer_v15_key_to_zoom,
  #multiplayer_client_baoquan,
  heavy_musket_aimming,
  #dedal_shield_taunt,
...
#-----------------------------------------------------------------
  ...
  (
    ...
    [
      ...
      (0, 0, 0, [(neg|multiplayer_is_dedicated_server),(key_clicked,key_m), (neg|is_presentation_active, "prsnt_multiplayer_admin_chat"),],
       [##fixed ilam
         (try_begin),
          ...
          [
                ...
                (try_for_players, ":player_no", "$g_ignore_server"),
                  ...
                  (try_begin),
                    ...
                    (else_try),
                      (this_or_next|eq,":player_faction","fac_poland"), #Rhine has French tunes
                      (eq,":player_faction","fac_france"),
                      (store_sub,":num_tunes",drum_sounds_france_end,drum_sounds_france_begin),
                    (else_try),
 ...
 #    multiplayer_server_bonuses_cb = ( # Officer and flag Bonuses #patch1115 43/16 begin
  ...
  (
    ...
    ("multiplayer_br",mtf_battle_mode,-1, #Invasion mode
    "You lead your men to battle.",
    [
      (0,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (1,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      ...
      (32,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (33,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (34,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (35,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (36,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (37,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (38,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
      (39,mtef_visitor_source|mtef_team_0|mtef_no_auto_reset,0,aif_start_alarmed,1,[]),
...
#               (eq, ":team2_living_players", 0),                
           ...
           (try_for_players, ":cur_player", "$g_ignore_server"),
             (player_is_active, ":cur_player"),
             (neq,":cur_player",0),
             (multiplayer_send_2_int_to_player, ":cur_player", multiplayer_event_set_team_score, ":team_1_score", ":team_2_score"),
           (try_end),
                   #(team_set_score, 0, "$last_wave"), #extra
                   (assign, "$wave_number", 0),
                   (assign, "$wave_counted", 0),
                   (assign, "$g_winner_team", 1),
                   (assign, "$last_wave", 0),
                   (store_mission_timer_a, "$g_round_start_time"),
                   #(assign, "$g_invasion_timer_endwave", 0),
                   #(store_sub,"$g_invasion_timer_endwave","$g_invasion_timer_endwave","$g_round_start_time"),
      ...
      (0, 0, 0, [], #if there is nobody in any teams do not reduce round time.
       [
         ...
         (try_begin),
           (eq, ":human_agents_spawned_at_team_1", 0),
...
## To set the troops slot
#############
## Recuit ##
#############
      (ti_before_mission_start, 0, 0, [],
       [
        ##Set invader slots based on faction first.
    (team_get_faction, ":faction", 1),
    (try_begin),
       (eq,":faction",fac_france),
       (faction_set_slot,":faction"  ,slot_faction_invader_1,"trp_french_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_2,"trp_french_infantry2_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_3,"trp_french_infantry_vistula_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_4,"trp_french_old_guard_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_5,"trp_french_voltigeur_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_6,"trp_french_hussar_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_7,"trp_french_lancer_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_8,"trp_french_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_9,"trp_french_cuirassier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_10,"trp_french_carabineer_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_11,"trp_french_grenadier_a_cheval_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_12,"trp_french_ship_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_13,"trp_french_ship_marine_ai"),
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_french_hussar_ai"),
       # (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_french_cuirassier_ai"),
       # (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_french_carabineer_ai"),
       # (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_french_cuirassier_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_french_hussar_ai"),
       # (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_french_cuirassier_ai"),
       # (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_french_carabineer_ai"),
       # (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_french_cuirassier_ai"),
##challenges
       # (faction_set_slot,":faction"  ,slot_faction_challenge_1,"trp_invader_challenge1"),
       # (faction_set_slot,":faction"  ,slot_faction_challenge_2,"trp_invader_challenge2"),
       # (faction_set_slot,":faction"  ,slot_faction_challenge_3,"trp_invader_challenge3"),     

    (else_try),
       (eq,":faction",fac_rhine),
       (faction_set_slot,":faction"  ,slot_faction_invader_1,"trp_rhine_infantry_bavaria_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_2,"trp_rhine_infantry_wurttemberg_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_3,"trp_rhine_infantry_saxony_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_4,"trp_rhine_infantry_wurttemberg2_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_5,"trp_rhine_grenadier_guard_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_6,"trp_rhine_light_infantry_hessen_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_7,"trp_rhine_light_infantry_bavaria_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_8,"trp_rhine_mounted_jaeger_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_9,"trp_rhine_uhlan_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_10,"trp_rhine_light_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_11,"trp_rhine_cuirassier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_12,"trp_rhine_garde_du_corps_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_13,"trp_rhine_arty_ai"),
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_rhine_mounted_jaeger_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_rhine_mounted_jaeger_ai"),

    (else_try),
       (eq,":faction",fac_britain),
       (faction_set_slot,":faction"  ,slot_faction_invader_1,"trp_british_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_2,"trp_british_infantry2_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_3,"trp_british_highlander_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_4,"trp_british_foot_guard_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_5,"trp_british_light_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_6,"trp_british_rifle_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_7,"trp_british_hussar_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_8,"trp_british_light_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_9,"trp_british_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_10,"trp_british_horseguard_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_11,"trp_british_ship_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_12,"trp_british_ship_marine_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_13,"trp_british_arty_ai"),
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_british_hussar_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_british_hussar_ai"),
       
    (else_try),
       (eq,":faction",fac_prussia),
       (faction_set_slot,":faction"  ,slot_faction_invader_1,"trp_prussian_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_2,"trp_prussian_infantry2_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_3,"trp_prussian_infantry_kurmark_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_4,"trp_prussian_infantry_freikorps_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_5,"trp_prussian_infantry_15_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_6,"trp_prussian_infantry_rifle_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_7,"trp_prussian_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_8,"trp_prussian_hussar_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_9,"trp_prussian_landwehr_cav_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_10,"trp_prussian_cuirassier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_11,"trp_prussian_arty_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_12,"trp_prussian_arty_alt_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_13,"trp_prussian_arty_alt_ai"),
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_prussian_infantry_15_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_prussian_infantry_15_ai"),
...
##minions
    ...
    (else_try),
       (eq,":faction",fac_russia),
       (faction_set_slot,":faction"  ,slot_faction_invader_1,"trp_russian_partizan_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_2,"trp_russian_opol_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_3,"trp_russian_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_4,"trp_russian_grenadier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_5,"trp_russian_foot_guard_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_6,"trp_russian_infantry_rifle_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_7,"trp_russian_hussar_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_8,"trp_russian_uhlan_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_9,"trp_russian_cossack_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_10,"trp_russian_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_11,"trp_russian_horse_guard_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_12,"trp_russian_arty_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_13,"trp_russian_arty_alt_ai"),
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_russian_uhlan_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_russian_uhlan_ai"),

    (else_try),
       (eq,":faction",fac_austria),
       (faction_set_slot,":faction"  ,slot_faction_invader_1,"trp_austrian_infantry_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_2,"trp_austrian_infantry2_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_3,"trp_austrian_grenzer_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_4,"trp_austrian_grenadier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_5,"trp_austrian_infantry_rifle_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_6,"trp_austrian_hussar_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_7,"trp_austrian_uhlan_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_8,"trp_austrian_light_horse_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_9,"trp_austrian_dragoon_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_10,"trp_austrian_cuirassier_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_11,"trp_austrian_arty_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_12,"trp_austrian_arty_alt_ai"),
       (faction_set_slot,":faction"  ,slot_faction_invader_13,"trp_austrian_arty_ai"),
##bosses
       (faction_set_slot,":faction"  ,slot_faction_boss_1,"trp_austrian_uhlan_ai"),
##minions
       (faction_set_slot,":faction"  ,slot_faction_boss_minion_1,"trp_austrian_uhlan_ai"),
...
#Wave timer           
      (0, 0, 0, [],
       [
        (store_mission_timer_a, ":round_time"), #Stores timer
        (val_sub, ":round_time", "$g_round_start_time"),
        (ton|gt, ":round_time", 20),
        (neq,"$g_invasion_timer_endwave",0),
        (assign, ":team2_living_players", 0),
        (try_for_agents, ":cur_agent"),
          (agent_is_human, ":cur_agent"),         
          (try_begin),
        ...
        (try_end),                    
         ...
         # (assign,  reg3,":team2_living_players"),
         # (display_message, "@team2_living_players : {reg3}"),
           
            (lt, ":team2_living_players", 1),
            (eq,"$g_invasion_timer_endwave",0),
            (store_mission_timer_a,"$g_invasion_timer_endwave"),
...
#Respawn remainder
	...
	(try_for_players, ":cur_player"),
        ...
        (try_begin),
           (ton|eq,"$wave_number",2),
           (ton|eq,"$wave_number",4),
           (ton|eq,"$wave_number",6),
           (ton|eq,"$wave_number",8),
           (ton|eq,"$wave_number",10),
           (ton|eq,"$wave_number",12),
           (ton|eq,"$wave_number",14),
           (ton|eq,"$wave_number",16),
           (ton|eq,"$wave_number",18),
           (ton|eq,"$wave_number",20),
           (ton|eq,"$wave_number",22),
           (ton|eq,"$wave_number",24),
           (ton|eq,"$wave_number",26),
           (ton|eq,"$wave_number",28),
           (ton|eq,"$wave_number",30),
           (ton|eq,"$wave_number",32),
           (ton|eq,"$wave_number",34),
           (eq,"$wave_number",36),
           (multiplayer_send_string_to_player, ":cur_player", multiplayer_event_return_admin_chat, "str_respawn_this"),
        # (else_try),
           # (multiplayer_send_string_to_player, ":cur_player", multiplayer_event_return_admin_chat, "str_respawn_next"),
        (try_end),
    (try_end),
         ]),
...
#AI attack obstacle
    ...
    [
        (try_for_agents, ":bot"),#Check if it is a bot
            (ge, ":bot", 0),
            (agent_is_active, ":bot"),
            (agent_is_alive, ":bot"),
            (agent_is_non_player, ":bot"),
            (agent_is_human, ":bot"),
            (agent_get_position, pos31, ":bot"),
            (try_for_range, ":scene_prop_id", mm_destructible_doors_begin, mm_destructible_doors_end),
                (scene_prop_get_num_instances, ":total_number", ":scene_prop_id"),
                (try_for_range, ":instance_no", 0, ":total_number"),
                    (scene_prop_get_instance, ":scene_prop_instance", ":scene_prop_id", ":instance_no"),
                    
                    (scene_prop_get_hit_points, ":hp", ":scene_prop_instance"),
                    
                    (prop_instance_get_position, pos10, ":scene_prop_instance"),
                    
                
                    (get_distance_between_positions_in_meters, ":distance", pos10, pos31),
                    

                    (agent_ai_set_always_attack_in_melee, ":bot", 0),
                    (try_begin),
                        (eq,":scene_prop_id",1161),
                        (le, ":distance", 5),
                        (gt,":hp",0),
                        (agent_ai_set_always_attack_in_melee, ":bot", 1),
                        (agent_set_look_target_position, ":bot", pos10),
                        (store_random_in_range, ":random", 0, 4),
                        (agent_set_attack_action, ":bot", ":random", 0),
                    (else_try,),
                        (le, ":distance", 1),
                        (gt,":hp",0),
                        (agent_ai_set_always_attack_in_melee, ":bot", 1),
...
#AI attack defance
    ...
    [
        (try_for_agents, ":bot"),#Check if it is a bot
            ...
            (agent_is_human, ":bot"),
            (agent_get_position, pos31, ":bot"),
            #Get info of obstacle
            (try_for_range, ":scene_prop_id", "spr_mm_stakes_destructible", "spr_mm_pontoon_bridge_short"),
                (scene_prop_get_num_instances, ":total_number", ":scene_prop_id"),
                (try_for_range, ":instance_no", 0, ":total_number"),
                    (scene_prop_get_instance, ":scene_prop_instance", ":scene_prop_id", ":instance_no"),
                    ...
                    #(display_message, "@bot lt 1"),
                
                    #(eq,":var_3","spr_castle_f_door_b"),
                    (agent_ai_set_always_attack_in_melee, ":bot", 0),
                    (get_distance_between_positions_in_meters, ":distance", pos10, pos31),
                    (le, ":distance", 1),
                    (gt,":hp",0),
                    
                    #(display_message, "@attack defance"),
                    ...
                    # (try_for_players,":player"),
                        # (multiplayer_send_3_int_to_player, ":player", multiplayer_event_return_bot_action, ":bot",":scene_prop_instance",":hp"),
                    # (try_end),
...
##Player win trigger
      ...
      (1, 0, 0, [],
       ...
       (team_get_score, ":team_1_score", 0),
       (team_get_score, ":team_2_score", 1),
       (eq,":team_1_score","$g_multiplayer_game_max_points"),
       (team_set_score, 0, 0),
       (team_set_score, 1, 0),  
...
##Invader lead group
    ...
    # (try_begin),
      ...
      # (assign, ":team2_player_count", 0),
      # (assign, ":team2_bot_count", 0),
      ...
      # (try_for_players, ":cur_player","$g_ignore_server"),
        ...
        # (agent_is_active,":cur_agent"),
        # (agent_is_alive,":cur_agent"),
        # (val_add, ":team2_player_count", 1),  #Count the team2 players
      # (try_end),
        ...
        # (try_for_agents,":bot"),
            ...
            # (try_begin),
                # (eq,":team",1),
                # (val_add, ":team2_bot_count", 1),  #Count the team2 bots
            # (try_end),
        # (try_end),
        ...
        # (try_begin),
            # (eq,":team2_player_count",0),
            # (try_for_agents,":agent_no"),
                # (agent_is_human,":agent_no"),
                # (agent_is_non_player,":agent_no"),
                # (agent_set_group, ":agent_no", -1),
            # (try_end),
        # (try_end),
        
        
         # (gt,":team2_player_count",0),
         # (gt,":team2_bot_count",0),
         
         
         
         # (store_div, ":num_bots_for_team2_player", ":team2_bot_count", ":team2_player_count"),
         ...
         # (try_for_agents,":agent_no"),
            ...
            # (try_for_players,":player_no","$g_ignore_server"),
                ...
                # (try_begin),
                    # (agent_is_alive, ":player_agent"),
                    # (player_get_slot, ":player_bot_count", ":player_no", slot_player_last_bot_count),
                    # (le,":player_bot_count",":num_bots_for_team2_player"),
                    # (agent_get_group, ":group", ":agent_no"),
                    # (lt,":group",0),
                    # (agent_set_group, ":agent_no", ":player_no"),
                # (else_try),
                    # (neg|agent_is_alive, ":player_agent"),
                    # (agent_set_group, ":agent_no", -1),
                # (try_end),
       ...
       [
        ...
        (try_begin),
            ...
            (try_for_players, ":player"),
                ...
                (multiplayer_send_string_to_player, ":player", multiplayer_event_return_admin_chat, "str_round1"),
            (try_end),
        (try_end),
        
        (gt, ":round_time", 20),
        
        # (assign,reg3,":round_time"),
        # (display_message, "@Variable : {reg3}"),

        (assign, ":team2_living_players", 0),

        (assign, ":invader_team", 1),
        (call_script, "script_multiplayer_find_bot_troop_and_group_for_spawn", ":invader_team", 1),
        (assign, ":selected_group", reg1),

        # (assign,  reg3,":selected_group"),
        # (display_message, "@selected_group : {reg3}"),

        (assign, ":start_wave", 0),

        # (assign,  reg2,"$wave_number"),
        # (display_message, "@Variable : {reg2}"),



        (try_begin),
          (lt, "$wave_counted", 1),
          (store_add, "$wave_number", ":start_wave", 1),
        (try_end),
...
##Difficulty! Increases with players.
        ...
        # (assign,  reg2,":player_count"),
        # (display_message, "@player_count : {reg2}"),
         
         (store_div, ":difficulty", ":player_count", 8),
  ...
  ##Invasion: 
        ...
        # (assign,  reg3,"$g_round_start_time"),
        # (display_message, "@g_round_start_time : {reg3}"),
        
        # (assign,  reg1,":round_time"),
        # (display_message, "@round_time : {reg1}"),
        
        # (assign,  reg2,"$wave_timer"),
        # (display_message, "@wave_timer : {reg2}"),
        
        # (assign,  reg2,"$g_invasion_timer_endwave"),
        # (display_message, "@g_invasion_timer_endwaver : {reg2}"),   
           
           (lt, ":team2_living_players", 1),
           
           
           
         # (assign,  reg2,"$last_wave"),
         # (display_message, "@last_wave : {reg2}"),   
         # (team_get_score, ":score", 0),
         
         # (assign,  reg3,":score"),
         # (display_message, "@score : {reg3}"),   
           
            (get_max_players, ":num_players"), #respawn every round
            (try_for_range, ":player_no", 0, ":num_players"),
                # (this_or_next|eq, "$wave_number", 2),
                # (this_or_next|eq, "$wave_number", 6),
                # (this_or_next|eq, "$wave_number", 10),
                # (this_or_next|eq, "$wave_number", 15),
                # (this_or_next|eq, "$wave_number", 18),
                # (this_or_next|eq, "$wave_number", 22),
                # (this_or_next|eq, "$wave_number", 26),
                # (this_or_next|eq, "$wave_number", 30),
                # (eq, "$wave_number", 34),
                
               (player_is_active, ":player_no"),
               (gt, ":player_no", -1),
               (player_get_agent_id, ":respawn_agent", ":player_no"),
               (this_or_next|lt, ":respawn_agent", 0),
               (neg|agent_is_alive, ":respawn_agent"),
               (player_get_team_no,":player_team",":player_no"),
               (neq,":player_team",1),
              (agent_set_hit_points,":respawn_agent",100,0),
               #(eq, "$g_multiplayer_player_respawn_as_bot", 1),
               (player_set_slot, ":player_no", slot_FuIn_respawn, 1),
            (try_end),
           
           
           
           # (gt, ":round_time", 30),
           # (store_sub, ":timing", ":round_time","$wave_timer"),
          ...
          (try_begin),
            (this_or_next|eq, "$last_wave", 3),
            (this_or_next|eq, "$last_wave", 7),
            (this_or_next|eq, "$last_wave", 11),
            (this_or_next|eq, "$last_wave", 15),
            (this_or_next|eq, "$last_wave", 19),
            (this_or_next|eq, "$last_wave", 23),
            (this_or_next|eq, "$last_wave", 27),
            (this_or_next|eq, "$last_wave", 31),
            (eq, "$last_wave", 35),
            (try_for_players, ":player", ),
                (eq,":time_difference",1),
                (player_is_active, ":player"),
                (multiplayer_send_string_to_player, ":player", multiplayer_event_return_admin_chat, "str_boss_round"),
            (try_end),
          (else_try),
            (try_for_players, ":player", ),
                (eq,":time_difference",1),
                (player_is_active, ":player"),
                (multiplayer_send_string_to_player, ":player", multiplayer_event_return_admin_chat, "str_rounds"),
            (try_end),
          (try_end),
          ...
          #(team_set_score, 0, "$last_wave"),
          #(team_set_score, 1, "$last_wave"),

        (try_end),
        #Waves!
         #check the invader types
        (team_get_faction, ":faction", 1),
        
       (faction_get_slot,":boss1",":faction",slot_faction_boss_1),
       (faction_get_slot,":boss_minion1",":faction",slot_faction_boss_minion_1),

       #(faction_get_slot,":challenge1",":faction",slot_faction_challenge_1),


##Start Wave system#
        (assign, ":num_waves", 15), #Number of Waves here. 
        (val_add, ":num_waves",1), ##Because of the try_for_range function, add one
        (assign, ":invader_slot",  slot_faction_invader_2),
        
        # (assign,  reg3,"$wave_number"),
        # (display_message, "@wave_number : {reg3}"),
        
        # (assign,  reg1,":num_wave"),
        # (display_message, "@num_waver : {reg1}"),
        
        # (assign,  reg0,"$last_wave"),
        # (display_message, "@last_waver : {reg0}"),
        
        (try_for_range, ":num_wave", 1, ":num_waves"), #Waves!
        
        
          (neq, "$last_wave", ":num_wave"), #Do not repeat waves
          (eq, "$wave_number", ":num_wave"), #This is to make sure server and client are synced...I think

          (store_current_scene, ":cur_scene"), 
          (modify_visitors_at_site, ":cur_scene"),

          (assign, ":bot_default", 8),  
          (store_mul, ":bots", ":num_wave", 1.5), #At wave 3: 13 bots, wave 9: 22 bots, wave 15: 31 bots, may need tweaking 
          (val_add, ":bots", ":bot_default"),
          (val_mul, ":bots", ":difficulty"), #Depends on the number of players.

          (store_div, ":invader_offset",":num_wave", 2),
          (val_add, ":invader_slot", ":invader_offset"), #getting the right slot for the invader at wave 5, slot +1

          (faction_get_slot,":invader_begin",":faction",slot_faction_invader_1),
          (faction_get_slot,":invader_end",":faction",":invader_slot"),

          (assign, ":is_boss", 0),
          (try_begin), #Checks if the wave is a boss wave or challenge wave
            (this_or_next|eq, ":num_wave", 4),
            (this_or_next|eq, ":num_wave", 8),
            (this_or_next|eq, ":num_wave", 12),
            (this_or_next|eq, ":num_wave", 15),
            (this_or_next|eq, ":num_wave", 20),
            (this_or_next|eq, ":num_wave", 24),
            (this_or_next|eq, ":num_wave", 28),
            (this_or_next|eq, ":num_wave", 32),
            (eq, ":num_wave", 36),
            (assign, ":is_boss", 1), #boss waves
            (assign, ":bots", 1),
            
            (try_begin),
                (neq,":num_wave", 15),
                (store_sub, ":boss", ":num_wave", 4), #Bosses start at wave 4
                (val_div, ":boss", 4), #boss every 4 rounds
                (val_add, ":boss1", ":boss"),
                (val_add, ":boss_minion1", ":boss"),
            (else_try),
                (eq,":num_wave", 15),
                (store_sub, ":boss", ":num_wave", 4), #Bosses start at wave 4
                (val_div, ":boss", 4), #boss every 4 rounds
                ...
                (val_add, ":boss_minion1", ":boss"),
                (val_add, ":boss1", 1),
                (val_add, ":boss_minion1", 1),
            (try_end),
          # (else_try),
            # (this_or_next|eq, ":num_wave", 2),
            # (this_or_next|eq, ":num_wave", 6),
            # (this_or_next|eq, ":num_wave", 10),
            # (this_or_next|eq, ":num_wave", 14),
            # (this_or_next|eq, ":num_wave", 18),
            # (this_or_next|eq, ":num_wave", 22),
            # (this_or_next|eq, ":num_wave", 26),
            # (this_or_next|eq, ":num_wave", 30),
            # (eq, ":num_wave", 34),
            # (assign, ":is_boss", 2), #challenge waves
            # (assign, ":bots", 7), 

            # (store_sub, ":challenge", ":num_wave", 2), #Challenges start at wave 2
            # (val_div, ":challenge", 4), #challenge every 4 rounds
            # (val_add, ":challenge1", ":challenge"),
          (try_end),
         
        
          (try_for_range, ":unused", 0, ":bots"), #Spawns the bots, is different for bosses and challenges
            (eq, ":is_boss", 1), ##boss
            (try_for_range, ":player_no", 0, ":num_players"),    #Spawn invader players
               (player_is_active, ":player_no"),
               (gt, ":player_no", -1),
               (player_get_agent_id, ":respawn_agent", ":player_no"),
               (player_get_team_no,":invader_faction",":player_no"),
               (eq,":invader_faction",1),
               #(this_or_next|lt, ":respawn_agent", 0),
               (neg|agent_is_alive, ":respawn_agent"),
               (agent_set_hit_points,":respawn_agent",100,0),
               (player_set_slot, ":player_no", slot_FuIn_respawn, 1),
            (try_end),
            (store_mul,":minion_num",10,":difficulty"),
            (store_random_in_range, ":spawn", 32, 40),        
            (add_visitors_to_current_scene,":spawn",":boss1",1, ":invader_team", ":selected_group"),
            (add_visitors_to_current_scene,":spawn",":boss_minion1",":minion_num", ":invader_team", ":selected_group"),
            # (try_for_range, ":player_no", 0, ":num_players"),    #Spawn players as boss
               # (player_is_active, ":player_no"),
               # (gt, ":player_no", -1),
               # (player_get_agent_id, ":respawn_agent", ":player_no"),
               # (player_get_team_no,":invader_faction",":player_no"),
               ...
               # (neg|agent_is_alive, ":respawn_agent"),
               # (try_for_agents,":bots"),
                    # (agent_get_troop_id,":troop",":bots"),
                    # (eq,":troop",":boss1"),
                    # (player_control_agent, ":player_no", ":bots"),
               # (try_end),
            # (try_end),
          # (else_try),
            # (eq, ":is_boss", 2), ##challenge
            # (store_random_in_range, ":spawn", 32, 40),        
            # (add_visitors_to_current_scene,":spawn",":challenge1",1, ":invader_team", ":selected_group"), 
          (else_try),
            (try_for_range, ":player_no", 0, ":num_players"),    #Spawn invader players
               (player_is_active, ":player_no"),
               (gt, ":player_no", -1),
            ...
            (try_end),
            (store_random_in_range, ":spawn", 32, 40),        
            (store_random_in_range, ":random_bot", ":invader_begin", ":invader_end"),        
            (add_visitors_to_current_scene,":spawn",":random_bot",1, ":invader_team", ":selected_group"), 
            # (else_try),
                # (gt,":player_count",1), #These is some player in invader team
                # (try_for_players,":player"),
                    # (player_get_team_no, ":team", ":player"),
                    # (eq,":team",1),
                    # (store_random_in_range, ":spawn", 32, 40),        
                    # (store_random_in_range, ":random_bot", ":invader_begin", ":invader_end"),        
                    # (add_visitors_to_current_scene,":spawn",":random_bot",1, ":invader_team", ":player"), 
                # (try_end),
            # (try_end),
          (try_end),
          ...
          (try_begin),
            (eq,":num_wave", 1),
            (assign, "$wave_counted", 1),
            #(assign, "$wave_timer", ":round_time"),
          (try_end),
        
          (assign, "$last_wave", ":num_wave"),

            (get_max_players, ":num_players"), #respawn after boss
            (try_for_range, ":player_no", 0, ":num_players"),
              (eq, "$boss_done", 1), #last wave was a boss wave?
              (neq, ":num_wave", 1), #
...
#               (agent_set_hit_points,":respawn_agent",100,0),
               ...
               #(player_get_agent_id, ":player_agent", ":player_no"),
                ...
                (try_for_agents,":player_agent"),
                    ...
                    (agent_set_hit_points, ":player_agent", 100, 0), # Heal the player
           
                    (agent_refill_ammo,":player_agent"), # and refill ammo.
                    
                    
                 (try_end),
            (try_end),
              (assign, "$boss_done", 0), #resetting

          (try_begin), ##In case last wave was a boss wave, allow respawning next round
             (eq, ":is_boss", 1),
             (assign, "$boss_done", 1),
          (try_end),
      ...
      (3, 0, 0, [],
       [
        (try_for_agents, ":cur_agent"),
           ...
           (agent_is_non_player, ":cur_agent"),
           (agent_force_rethink, ":cur_agent"),
           (agent_ai_set_aggressiveness,  ":cur_agent", 200),
        ]),
       ...
       [
         ...
         (try_for_range, ":player_no", 0, ":num_players"),
           ...
           (try_begin),
             ...
             (player_slot_eq, ":player_no", slot_FuIn_respawn, 1),
             ...
             (try_begin),
               (eq, ":player_team", 0),
               (store_random_in_range, ":entry_no", 0,2), ##FuIn random defender spawn place
             (else_try),
               (eq, ":player_team", 1),
               (store_random_in_range, ":entry_no", 32,40), ##FuIn random attacker spawn place
             (try_end),
             (call_script, "script_multiplayer_buy_agent_equipment", ":player_no", -1), #FuIn 
             (player_spawn_new_agent, ":player_no", ":entry_no"),
             (player_set_slot, ":player_no", slot_player_spawned_this_round, 1),
             (player_set_slot, ":player_no", slot_FuIn_respawn, 0),
           (try_end),
         (try_end),
         ]),
