...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_unarmed", 0, amf_client_prediction,
   ...
   [15.2, "stand_a", 0, 79, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [40.3, "new_stand_unarmed", 0, 19, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_single", 0, amf_client_prediction,
   [100, "general_officer_idle", 0, 74, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.25],
   [100, "new_stand_onehand", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.25],
   [100, "new_stand_onehand_2", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.25],
 ],
 ["stand_greatsword", 0, amf_client_prediction,
[6.000000, "twohanded_01", 0, 100, arf_cyclic|arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.250000],
[6.000000, "twohanded_02", 0, 200, arf_cyclic|arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.250000],
[6.000000, "twohanded_03", 0, 100, arf_cyclic|arf_use_stand_progress, 0, (0.000000, 0.000000, 0.000000), 0.250000],
],
 ["stand_staff", 0, amf_client_prediction,
   [100.0, "new_stand_musket_2", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [100.0, "new_stand_musket_9", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [100.0, "new_stand_musket_3", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [100.0, "new_stand_musket_7", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [3.0, "new_stand_musket_brow", 0, 99, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [3.5, "new_stand_musket_look", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
   [100.0, "musket_holding", 0, 1, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],
   [100.0, "musket_holdin2", 0, 499, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],
   # [100.0, "gashajin_musket_3", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],
   # [100.0, "gashajin_musket_4", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],
 ],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
   ...
   [0.800000, "run_man_forward_onehanded_y2", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
 ...
 ["run_forward_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   ...
   [0.8, "new_run_musket", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "new_run_musket_1", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "new_run_musket_3", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "changbanbengpao", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
["run_forward_greatsword", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction, 
[0.800000, "run_forward_greatsword_y", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
[0.800000, "twohanded_run_02", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
[0.800000, "twohanded_run_03", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
[0.800000, "twohanded_run_04", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
[0.800000, "shuangshoubenpao", 0, 24, arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, 58726, (0.000000, 0.000000, 0.000000), 0.400000],
],
...
#   [1.0, "anim_human", 6000, 6020, arf_walk,pack2f(0.4,0.9)],
   [1.0, "man_walk", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "new_walk_onehand", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "new_walk_onehand_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
##   [1.0, "anim_human", 6100, 6120, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "new_walk_musket_holding", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "new_walk_musket_holding_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "new_walk_musket_holding_3", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "new_walk_musket_holding_4", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.450000, "dedal_walk_musket_long", 0, 32, arf_blend_in_1|arf_blend_in_3|arf_cyclic|arf_use_walk_progress, 0, (0.000000, 0.000000, 0.000000), 0.000000],
 ],
...
##   [22.0, "stand_onhorse_sword", 0, 671, arf_cyclic],
   [100.0, "new_mounted_onehand", 0, 671, arf_cyclic],
  ],
["ride_1", acf_synch_with_horse|acf_enforce_lowerbody, amf_client_prediction, 
[1.000000, "anim_human_02_old", 0, 31, arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.800000, "anim_human_02_old", 50, 69, arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["ride_3", acf_synch_with_horse|acf_enforce_lowerbody, amf_client_prediction, 
[0.600000, "anim_human_02_old", 100, 116, arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["ride_4", acf_synch_with_horse|acf_enforce_lowerbody, amf_client_prediction, 
[50.500000, "anim_human_02", 150, 165, arf_blend_in_0|arf_blend_in_31|arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[50.500000, "anim_human_02_old", 150, 165, arf_blend_in_0|arf_blend_in_31|arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[50.500000, "qimachongci", 0, 14, arf_blend_in_0|arf_blend_in_31|arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
##   [0.3, "anim_human", combat+10, combat+0, arf_blend_in_0],
 ...
 ["equip_katana", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   [0.600000, "defend_right_onehanded", 17, 27, arf_blend_in_0, 0, (0.000000, 0.000000, 0.000000), 0.000000],
 ],
...
# duration and controlled via weapon speed.
 ["ready_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_bow,
   [1.5, "shejian", 0, 24, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],
 ],
 ["release_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_bow,
   [0.3, "shejian", 24, 27, arf_blend_in_2],
 ],
# ["ready_bow", 1678770176, 606081034, 
# [1.500000, "bow_animation", 0, 12, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3|arf_make_custom_sound, 28707, (0.000000, 0.000000, 0.000000), 0.000000],
# ],

# ["release_bow", 1678770176, 572526602, 
# [0.300000, "bow_animation", 13, 14, arf_blend_in_0|arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
# ],
 #not used
...
[1.500000, "dedal_musket_long", 0, 20, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_crossbow", 1678770176, 572534845, 
[0.300000, "dedal_musket_long", 26, 51, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.300000, "dedal_musket_long_2", 26, 51, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
 ...
 ["ready_throwing_knife",  acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow|amf_use_weapon_speed, 
   [1.5, "sanyanchong", 17, 17, blend_in_ready],
 ],
 ["release_throwing_knife", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [1, "sanyanchong", 17, 44, arf_blend_in_1],
 ],
...
##   [0.7, "throw_stone", 0, 21, blend_in_ready],
   ...
   #[0.6, "ready_granate", 0, 18, blend_in_ready]
 ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
   ...
   #[0.9, "ready_granate", 18, 46, arf_blend_in_0]
 ],
 ...
 ["release_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol,
   ...
   [0.3, "anim_human", combat+2520, combat+2600, arf_blend_in_1],
 ],
 ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [3.0, "shouqiangshangdan", 0, 264, arf_blend_in_8|arf_make_custom_sound, pack2f(0.01, 1.00)],   
 ],
 ["ready_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow|amf_use_weapon_speed, 
   [1.5, "new_ready_musket", 2, 2, blend_in_ready],
   [1.5, "new_ready_musket5", 2, 2, blend_in_ready],
   [1.5, "new_ready_musket6", 2, 2, blend_in_ready],
   [1.500000, "dedal_musket_ready", 0, 80, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
 ],
 ["release_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow|amf_use_weapon_speed,
   [0.1, "new_ready_musket", 0, 17, arf_blend_in_1],
   [0.200000, "dedal_musket_new_2", 30, 51, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
   [0.200000, "dedal_musket_new", 30, 51, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
   #[0.14, "new_ready_musket6", 0, 16, arf_blend_in_1],
 ],
...
[0.350000, "XZ_slashright_twohanded", 10, 16, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_slashright_twohanded", 1678901248, 2183135242, 
[0.610000, "XZ_slashright_twohanded", 16, 38, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_slashright_twohanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction, 
[0.500000, "XZ_slashright_twohanded", 38, 61, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.350000, "anim_human", 25450, 25450, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_thrust_twohanded", 1678835712, 2183135242, 
[0.620000, "anim_human", 25466, 25481, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_thrust_twohanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction, 
[0.300000, "anim_human", 25481, 25475, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["blocked_thrust_twohanded", 0, amf_priority_jump|amf_priority_continue|amf_priority_cancel|amf_use_weapon_speed|amf_play, 
[0.600000, "anim_human", 25470, 25461, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["parried_thrust_twohanded", 0, amf_priority_jump|amf_priority_continue|amf_priority_cancel|amf_use_weapon_speed|amf_play, 
[0.700000, "anim_human", 25470, 25461, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.350000, "attacks_thrust_onehanded_01", 5, 13, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.350000, "attacks_thrust_onehanded_02", 0, 7, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.350000, "attacks_thrust_onehanded_03", 0, 9, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.350000, "attacks_thrust_onehanded_04", 0, 16, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_thrust_onehanded", 1679884800, 2183159818, 
[0.620000, "attacks_thrust_onehanded_01", 13, 32, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.620000, "attacks_thrust_onehanded_02", 7, 20, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.620000, "attacks_thrust_onehanded_03", 9, 22, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.620000, "attacks_thrust_onehanded_04", 16, 35, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.300000, "attacks_thrust_onehanded_01", 32, 54, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
# [0.350000, "attacks_single_lefttoright_01", 2, 14, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
# [0.350000, "attacks_single_lefttoright_02", 2, 21, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
# ],

# ["release_slashleft_onehanded", 1680080896, 2183135242, 
# [0.610000, "attacks_single_lefttoright_01", 14, 29, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
# [0.610000, "attacks_single_lefttoright_02", 21, 44, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
# ],

# ["release_slashleft_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction, 
# [0.400000, "attacks_single_lefttoright_01", 29, 43, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
# ],
...
[0.350000, "parry_attack_overswing_onehanded", 9, 18, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["release_overswing_onehanded", acf_enforce_rightside|acf_overswing, 2183155722, 
[0.600000, "parry_attack_overswing_onehanded", 18, 39, arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[1.000000, "parry_attack_overswing_onehanded", 39, 60, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
["ready_slash_horseback_polearm_right", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_right,
   [ready_durn, "attacks_staff_righttoleft", 6, 16, blend_in_ready], 
 ],
 ["release_slash_horseback_polearm_right", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_right|amf_continue_to_next,
 ...
 ["ready_slash_horseback_polearm_left", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_swing_left,
   [ready_durn, "attacks_staff_lefttoright", 10, 16, blend_in_ready], 
 ],
 ["release_slash_horseback_polearm_left", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_swing_left|amf_continue_to_next,
...
#   [0.3, "anim_human", defend+320, defend+330, arf_blend_in_1], 
   [0.3, "2h_low_beat_12.11.10", 5, 13, arf_blend_in_1], 
 ],
...
[0.750000, "defend_onehanded", 20, 41, arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.300000, "defend_forward_onehanded", 29, 31, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
[0.600000, "parry_attack_thrust_onehanded", 23, 31, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.60000, "defend_up_onehanded", 9, 25, arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.600000, "defend_up_onehanded", 16, 25, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.600000, "defend_right_onehanded", 24, 32, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
[0.600000, "defend_left_onehanded", 19, 25, arf_blend_in_1, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
 ...
 ["fall_face_hold", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [4.6, "new_head_death", 0, 74, arf_blend_in_16|arf_make_custom_sound, pack2f(0.7, 0.0), (0,0,0), 0.9],
   [2.4, "death_impact_front_fall_backwards_01", 0, 51, arf_blend_in_16|arf_make_custom_sound, pack2f(0.62, 0.0), (0,0,0), 1.7],
 ],
...
#  [2.9, "death_impact_front_fall_backwards_01", 0, 51, arf_blend_in_16|arf_make_custom_sound, pack2f(0.61, 0.0), (0,0,0), 1.6],
  [4.72, "new_death_stomach", 0, 99, arf_blend_in_16|arf_make_custom_sound, pack2f(3.79, 0.0), (0,0,0), 6.2],
  [4.68, "new_death_stomach_2", 0, 96, arf_blend_in_16|arf_make_custom_sound, pack2f(3.12, 0.0), (0,0,0), 6.3],
 ],
 ...
 ["fall_right_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [1.93, "death_impact_front_fall_backwards_02", 0, 61, arf_blend_in_16|arf_make_custom_sound, pack2f(3.72, 0.0), (0,0,0), 4.8],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_unarmed", 0, amf_client_prediction,
   [100.0, "ani_crouching_idle", 0,19, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ...
 ["crouch_staff", 0, amf_client_prediction,
   [100.0, "crouch_down_hold_musket", 1, 1, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 ...
 ["reload_musket_full", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
  [3.0, "man_reload", 1, 485, arf_stick_item_to_left_hand|arf_blend_in_3|arf_make_custom_sound, pack2f(0.10, 1.00)],
 ],
 ["reload_musket_two_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [1.9, "man_reload", 210, 485, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ["reload_musket_one_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [0.8, "man_reload", 370, 485, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ...
 #],
 ["ready_overswing_musket", acf_rot_vertical_sword| acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
  [ready_durn, "anim_human", 28500, 28500, blend_in_ready],
 ],
 ["release_overswing_musket", acf_rot_vertical_sword|acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next|amf_rider_rot_thrust,
  [0.4, "anim_human", 28516, 28529, blend_in_release],#78
 ],
 ["release_overswing_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_thrust,
  [0.1, "anim_human", 28529, 28523, arf_blend_in_2],
 ],
 ["parried_overswing_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [0.3, "anim_human", 28529, 28516, blend_in_parry],
 ],
 ["blocked_overswing_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
   [0.3, "anim_human", 28529, 28516, blend_in_parry],#95 79
 ],
 ...
 ["drum", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [3.5, "new_drumming", 0, 30, arf_blend_in_5|arf_cyclic],
  ],
 ...
 ["horn", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [100.0, "new_bugling", 1, 1, arf_blend_in_5|arf_cyclic],
  ],
 ...
 ["surrender", acf_enforce_all, amf_play|amf_keep|amf_priority_mount,
   [100.0, "new_surrender", 0, 1, arf_blend_in_5|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
...
["bash_knocked", acf_enforce_all|acf_align_with_ground,amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [2.0, "anim_human", blow+5400, blow+5453, arf_blend_in_2],
],
# strike_chest_front_stop
["bash_stun", acf_enforce_all,amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [1.5, "anim_human", blow+5000, blow+5010, arf_blend_in_3],
],
# strike_chest_front_stop
["bash_mini_stun", acf_enforce_all,amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [0.6, "anim_human", blow+5000, blow+5010, arf_blend_in_3],
],
# anim jump end
["bash_crouch", acf_enforce_all|acf_enforce_lowerbody,amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [0.5, "anim_human", 280, 290, arf_blend_in_3],
],  
# strike_head_front_left
["bash_unsuccessful", acf_enforce_all,amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [0.55, "anim_human", blow+0, blow+10, arf_blend_in_3],
],

["release_bash", acf_enforce_all|acf_right_cut|acf_parallels_for_look_slope,amf_play|amf_restart|amf_priority_reload|amf_accurate_body,
   [0.62, "defend_shield_right", 0, 30, arf_blend_in_1],
   [0.62, "anim_human", combat+5710, combat+5740, blend_in_release],
],
 ...
 ["baoquan", 0, amf_play|amf_priority_mount,
   [2.0, "baoquan", 4, 24, arf_blend_in_5],
 ],
 
 ["dance2", 0, amf_play|amf_priority_mount,
   [2.0, "gesakewu", 0, 24, arf_blend_in_5],
 ],
 
 ["say_hello", 0, amf_play|amf_priority_mount,
   [2.0, "shenshou", 0, 10, arf_blend_in_5],
 ],
 
 ["bow", 0, amf_play|amf_priority_mount,
   [2.0, "oushijingli", 0, 30, arf_blend_in_5],
 ],
 
 ["bow_jap", 0, amf_play|amf_priority_mount,
   [2.0, "jugong", 0, 13, arf_blend_in_5],
 ],
 
 ["bow_jin", 0, amf_play|amf_priority_mount,
   [2.0, "taijianjingi", 0, 19, arf_blend_in_5],
 ],
 
 ["ziwen",  acf_enforce_all, 176160848, 
   [1.0, "ziwen", 0, 20, arf_blend_in_5],
 ],
 
 ["qiefu",acf_enforce_all, 176160848, 
   [3.0, "guidiqiefu", 0, 60, arf_blend_in_5],
 ],
 
 ["qisi",acf_enforce_all, 176160848, 
   [3.0, "qisi", 0, 55, arf_blend_in_5],
 ],
 
 ["shouqiangzisha", acf_enforce_all, 176160848, 
   [3.0, "shouqiangzisha2", 0, 29, arf_blend_in_5],
 ],
...
["fire_grenade",acf_enforce_all, 176160848, 
[3, "dianranzhadan", 0, 27, arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
 
["string_bow",acf_enforce_all, 176160848, 
[2, "chaijiejianxian", 0, 49, arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
 
["stand_musket", acf_enforce_all, 67108873, 
[3.000000, "dedal_stand_musket_long", 1, 60, arf_blend_in_0|arf_blend_in_3|arf_blend_in_7|arf_cyclic, 0, (0.000000, 0.000000, 0.000000), 0.000000],
 ],
 
["order", 0, amf_play|amf_priority_mount,
[1.0, "chongfeng", 9, 45, arf_blend_in_0|arf_blend_in_1|arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],

["lance_broken", 0, 176160848, 
[0.100000, "lancer_ride4_no_shield", 1, 2, arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
 
 ["release_gatling", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
 ],
 
["whistle",acf_enforce_all, 176160848, 
[2, "koushao", 0, 20, arf_blend_in_3, 0, (0.000000, 0.000000, 0.000000), 0.000000],
],
 
["fangun_forward", acf_enforce_all|acf_displace_position, amf_priority_defend_parry|amf_play|amf_accurate_body,#Forward
   [0.8, "fangun_forward", 0, 72,  arf_blend_in_1, 0, (0,2,0)],
],


["fangun_backward", acf_enforce_all|acf_displace_position, amf_priority_defend_parry|amf_play|amf_accurate_body,#Backward
   [0.8, "fangun_backward", 0, 72, arf_blend_in_1, 0, (0,-2,0)],
],

["fangun_left", acf_enforce_all|acf_displace_position, amf_priority_defend_parry|amf_play|amf_accurate_body,#Left
   [0.8, "fangun_left", 0, 72, arf_blend_in_1, 0, (-2,0,0)],
],

["fangun_right", acf_enforce_all|acf_displace_position, amf_priority_defend_parry|amf_play|amf_accurate_body,#Right
   [0.8, "fangun_right", 0, 72, arf_blend_in_1, 0, (2,0,0)],
],

["shanbi_forward", acf_enforce_lowerbody, amf_priority_jump|amf_play|amf_accurate_body|amf_client_prediction,#Forward
   [0.5, "shanbi_forward", 0, 50, arf_blend_in_1,],
],

["shanbi_backward", acf_enforce_lowerbody, amf_priority_jump|amf_play|amf_accurate_body|amf_client_prediction,#Backward
   [0.5, "shanbi_backward", 0, 50, arf_blend_in_1,],
],

["shanbi_left", acf_enforce_lowerbody, amf_priority_jump|amf_play|amf_accurate_body|amf_client_prediction,#Left
   [0.5, "shanbi_left", 0, 50, arf_blend_in_1,],
],

["shanbi_right", acf_enforce_lowerbody, amf_priority_jump|amf_play|amf_accurate_body|amf_client_prediction,#Right
   [0.5, "shanbi_right", 0, 50, arf_blend_in_1,],
],

["fei", acf_enforce_lowerbody, amf_priority_jump|amf_play|amf_accurate_body|amf_keep|amf_client_prediction,#Fly
   [0.5, "fei", 0, 10, arf_blend_in_1, 0, (0,0,2.5)],
],
 
["ninjia_backward", acf_enforce_all|acf_displace_position, amf_priority_defend_parry|amf_play|amf_accurate_body,#Backward
   [1.0, "houk", 0, 26, arf_blend_in_1, 0, (0,-3,1)],
],
 
 ["wuqiang", 0, amf_play|amf_priority_mount,
   [3.0, "wuqiang", 0, 59, arf_blend_in_5],
 ],
