...
def spr_cart_triggers(horse=1, detach_offset=0, detach_rotation=0, access_distance=100, use_string="str_attach"):
...
check_common_object_hit_trigger,
   ...
   (ti_on_init_scene_prop,
    [
      ...
      (scene_prop_set_hit_points, ":instance_no", 5000),
      (scene_prop_set_slot,":instance_no",scene_prop_slot_health,5000),
      (scene_prop_set_slot,":instance_no",scene_prop_slot_max_health,5000),
    ]),
...
check_common_object_hit_trigger = (ti_on_scene_prop_hit,
  [
    ...
    (try_for_players,":player"),
        (multiplayer_send_2_int_to_player, ":player", multiplayer_event_return_bot_action,":instance_no",":hit_points"),
    (try_end),
...
check_common_constructable_prop_on_hit_trigger = (ti_on_scene_prop_hit,
  [
    ...
    (try_for_players,":player"),
        (multiplayer_send_2_int_to_player, ":player", multiplayer_event_return_bot_action,":instance_no",":health"),
    (try_end),
   ...
   (ti_on_scene_prop_init,
    ...
    (neg|multiplayer_is_dedicated_server),
	 ...
	 #v15
          ...
          (try_begin),
            (is_between,reg(12),5,20),
            (store_mul, ":red", 5 * 180, ":scale"),#-40
            (store_mul, ":green", 5 * 173, ":scale"),
            (store_mul, ":blue", 5 * 130, ":scale"),
          (else_try),
            (store_mul, ":red", 5 * 80, ":scale"),
            (store_mul, ":green", 5 * 105, ":scale"),
            (store_mul, ":blue", 5 * 140, ":scale"),
          (try_end),
          (val_div, ":red", 100),
          (val_div, ":green", 100),
          (val_div, ":blue", 100),
   ...
   (ti_on_scene_prop_init,
    ...
    (neg|multiplayer_is_dedicated_server),
	 ...
	 #v15
          ...
          (try_begin),
            (is_between,reg(12),5,20),
            (store_mul, ":red", 5 * 250, ":scale"),#-40
            (store_mul, ":green", 5 * 243, ":scale"),
            (store_mul, ":blue", 5 * 190, ":scale"),
          (else_try),
            (store_mul, ":red", 5 * 120, ":scale"),
            (store_mul, ":green", 5 * 145, ":scale"),
            (store_mul, ":blue", 5 * 190, ":scale"),
          (try_end),
          (val_div, ":red", 100),
          (val_div, ":green", 100),
   ...
   (ti_on_scene_prop_init,
    ...
    (neg|multiplayer_is_dedicated_server),
	 ...
	 #v15
          ...
          (try_begin),
            (is_between,reg(12),5,20),
            (store_mul, ":red", 5 * 160, ":scale"),#-40
            (store_mul, ":green", 5 * 153, ":scale"),
            (store_mul, ":blue", 5 * 140, ":scale"),
          (else_try),
            (store_mul, ":red", 5 * 50, ":scale"),
            (store_mul, ":green", 5 * 75, ":scale"),
            (store_mul, ":blue", 5 * 110, ":scale"),
          (try_end),
          (val_div, ":red", 100),
          (val_div, ":green", 100),
          (val_div, ":blue", 100),
   ...
   (ti_on_scene_prop_init,
    ...
    (neg|multiplayer_is_dedicated_server),
     ...
     (particle_system_add_new, "psys_candle_light_small"),
          ...
          (try_begin),
            (is_between,reg(12),5,20),
            (store_mul, ":red", 5 * 140, ":scale"),#-60
            (store_mul, ":green", 5 * 133, ":scale"),
            (store_mul, ":blue", 5 * 120, ":scale"),
          (else_try),
            (store_mul, ":red", 5 * 30, ":scale"),
            (store_mul, ":green", 5 * 55, ":scale"),
            (store_mul, ":blue", 5 * 90, ":scale"),
          (try_end),
          (val_div, ":red", 100),
          (val_div, ":green", 100),
          (val_div, ":blue", 100),
   ...
   ("mm_ice4" ,0,"ice4" ,"bo_ice4" , []),
    ...
    # this bird is used as ending for explosive crates!
	 ...
	 #v15
	   ...
	   [
		 (store_trigger_param_1, ":instance_no"),
		 (prop_instance_deform_in_cycle_loop, ":instance_no", 1, 18, 2900),
	   ]
	   ),
	 #v15 end
       (ti_on_scene_prop_destroy,
 ...
 # ("doors_end", 0,"0" ,"0" , []),
  ...
  #    check_common_construction_props_use_trigger,
   ...
   # ("mm_sp_rich_street6",0,"sp_rich_village_street6","bo_sp_rich_village_street6", []),
    ...
    ("mm_new_rocket_code_only",sokf_static_movement, "new_rocket_arrow" , "0" , []),
    ...
    ("mm_new_rocket_wood" ,sokf_static_movement,"new_rocket_wood" ,"0" , []),
    ...
    ("pw_cart_a",sokf_static_movement|spr_use_time(3)|sokf_dont_move_agent_over,"che_ma2","bo_che_ma2", spr_cart_triggers(detach_offset=60, detach_rotation=-20, access_distance=-180)),

    ("pw_cart_a_wheels",sokf_static_movement,"che_ma2_wheels","0",[]),
...
("fysg_chuan_move", sokf_moveable, "fysg_chuan", "bo_fysg_chuan", []),
...
("Z_arena", 0, "Z_arena", "bo_Z_arena", []),
("Z_dimian", 0, "Z_dimian", "bo_Z_dimian", []),
("ylyq_liba", 0, "ylyq_liba", "bo_ylyq_liba", []),
("fysg_changjin_chengqiang04", 0, "fysg_changjin_chengqiang04", "bo_fysg_changjin_chengqiang04", []),
("Z_baguazhen", 0, "Z_baguazhen", "bo_Z_baguazhen", []),
("fysg_deng", 0, "fysg_deng", "bo_fysg_deng", []),
("fysg_meishu", 0, "fysg_meishu", "bo_fysg_meishu", []),
("Z_ship", 0, "Z_ship", "bo_Z_ship", []),
("ylyq_huasu", 0, "ylyq_huasu", "bo_ylyq_huasu", []),
("ylyq_taosu6", 0, "ylyq_taosu6", "bo_ylyq_taosu6", []),
("ylyq_taosu7", 0, "ylyq_taosu7", "bo_ylyq_taosu7", []),
("new_fysg_changjin_fanzi03", 0, "new_fysg_changjin_fanzi03", "bo_new_fysg_changjin_fanzi03", []),
("new_fysg_changjin_fanzi04", 0, "new_fysg_changjin_fanzi04", "bo_new_fysg_changjin_fanzi04", []),

("a_sino_battlement_mamian", 0, "sino_battlement_mamian", "bo_sino_battlement_mamian", []),
("a_sino_sino_outpost_a", 0, "sino_outpost_a", "bo_sino_outpost_a", []),
("a_sino_gate_small", 0, "sino_gate_small", "bo_sino_gate_small", []),
("a_sino_battlement_corner_c", 0, "sino_battlement_corner_c", "bo_sino_battlement_corner_c", []),
("a_sino_battlement_corner_b", 0, "sino_battlement_corner_b", "bo_sino_battlement_corner_b", []),
("a_sino_battlement_corner_a", 0, "sino_battlement_corner_a", "bo_sino_battlement_corner_a", []),
("a_sino_battlement_g", 0, "sino_battlement_g", "bo_sino_battlement_g", []),
("a_sino_battlement_e", 0, "sino_battlement_e", "bo_sino_battlement_e", []),
("a_sino_battlement_d", 0, "sino_battlement_d", "bo_sino_battlement_d", []),
("a_sino_battlement_mamian_under_heavy_artillary", 0, "sino_battlement_mamian_under_heavy_artillary", "bo_sino_battlement_mamian_under_heavy_artillary", []),
("a_sino_battlement_mamian_under_artillary", 0, "sino_battlement_mamian_under_artillary", "bo_sino_battlement_mamian_under_artillary", []),
("a_sino_battlement_c_destroyed", 0, "sino_battlement_c_destroyed", "bo_sino_battlement_c_destroyed", []),
("a_sino_battlement_c", 0, "sino_battlement_c", "bo_sino_battlement_c", []),
("a_sino_battlement_c2", 0, "sino_battlement_c2", "bo_sino_battlement_c", []),
("a_sino_battlement_b", 0, "sino_battlement_b", "bo_sino_battlement_b", []),
("a_sino_battlement_a", 0, "sino_battlement_a", "bo_sino_battlement_a", []),
("a_bastion01", 0, "bastion01", "bo_bastion01", []),
("a_sino_official_interior", 0, "sino_official_interior", "bo_sino_official_interior", []),
("a_sino_watchtower", 0, "sino_watchtower", "bo_sino_watchtower", []),
("a_sino_battlement_c_totally_destroyed", 0, "sino_battlement_c_totally_destroyed", "bo_sino_battlement_c_totally_destroyed", []),
("a_sino_gatehouse", 0, "sino_gatehouse", "bo_sino_gatehouse", []),
("a_sino_gatehouseg", 0, "sino_gatehouseg", "bo_sino_gatehouseg", []),
("a_sino_battlement_c", 0, "sino_battlement_c", "bo_sino_battlement_c", []),
("a_korean_gatehouse_small", 0, "korean_gatehouse_small", "bo_korean_gatehouse_small", []),
("a_korean_outpost", 0, "korean_outpost", "bo_korean_outpost", []),
("a_korean_gate", 0, "korean_gate", "bo_korean_gate", []),
("a_korean_battlement_a", 0, "korean_battlement_a", "bo_korean_battlement_a", []),
("a_sino_guardtower", 0, "sino_guardtower", "bo_sino_guardtower", []),
("a_sino_battlement_h_wengcheng5", 0, "sino_battlement_h_wengcheng5", "bo_sino_battlement_h_wengcheng5", []),
("a_sino_battlement_h_wengcheng3_r", 0, "sino_battlement_h_wengcheng3_r", "bo_sino_battlement_h_wengcheng3_r", []),
("a_sino_battlement_h_wengcheng3_l", 0, "sino_battlement_h_wengcheng3_l", "bo_sino_battlement_h_wengcheng3_l", []),
("a_sino_battlement_h_wengcheng2_r", 0, "sino_battlement_h_wengcheng3_l", "bo_sino_battlement_h_wengcheng3_l", []),
("a_sino_battlement_h_wengcheng2_l", 0, "sino_battlement_h_wengcheng2_l", "bo_sino_battlement_h_wengcheng2_l", []),
("a_sino_sino_battlement_gate", 0, "sino_sino_battlement_gate", "bo_sino_battlement_gate", []),
("a_sino_battlement_h_pmen", 0, "sino_battlement_h_pmen", "bo_sino_battlement_h_pmen", []),
("a_sino_battlement_h_curve", 0, "sino_battlement_h_curve", "bo_sino_battlement_h_curve", []),
("a_sino_battlement_h_wengcheng_l", 0, "sino_battlement_h_wengcheng_l", "bo_sino_battlement_h_wengcheng_l", []),
("a_sino_battlement_h_wengcheng_r", 0, "sino_battlement_h_wengcheng_r", "bo_sino_battlement_h_wengcheng_r", []),
("a_sino_battlement_h_mamian", 0, "sino_battlement_h_mamian", "bo_sino_battlement_h_mamian", []),
("a_sino_battlement_h_corner", 0, "sino_battlement_h_corner", "bo_sino_battlement_h_corner", []),
("a_sino_battlement_c_destroyed", 0, "sino_battlement_c_destroyed", "bo_sino_battlement_c_destroyed", []),
("a_sino_battlement_h", 0, "sino_battlement_h", "bo_sino_battlement_h", []), 
 
("a_qianqingg_1", 0, "qianqingg_1", "bo_qianqingg_1", []),
("a_qianqingg_2", 0, "qianqingg_2", "bo_qianqingg_2", []),
("a_qianqingg_3", 0, "qianqingg_3", "bo_qianqingg_3", []),
("a_qianqingg_4", 0, "qianqingg_4", "bo_qianqingg_4", []),
("a_qianqingg_5", 0, "qianqingg_5", "bo_qianqingg_5", []),
("a_qianqingg_6", 0, "qianqingg_6", "bo_qianqingg_6", []),
("a_qianqingg_7", 0, "qianqingg_7", "bo_qianqingg_7", []),
("a_qianqingg_8", 0, "qianqingg_8", "bo_qianqingg_8", []),
("a_qianqingg_9", 0, "qianqingg_9", "bo_qianqingg_9", []),
 ("z_chengmen",0,"chengmen","bo_chengmen", []), 
 ("z_damen",0,"damen","bo_damen", []),
 ("z_tuqiang",0,"tuqiang","bo_tuqiang", []), 
 ("z_tuqiangb",0,"tuqiang_b","bo_tuqiangb", []), 
 ("z_wushiwu",0,"wushiwu","bo_wushiwu", []),
 ("z_wushiwud",0,"wushiwud","bo_wushiwud", []),
 ("z_dcqiang",0,"dcqiang","bo_dcqiang", []),
 ("z_dcqiangb",0,"dcqiangb","bo_dcqiangb", []),
 ("z_cangku",0,"cangku","bo_cangku", []), 
 ("z_mafang",0,"mafang","bo_mafang", []),
 ("z_wu",0,"wu","bo_wu", []),
 ("z_changwu",0,"changwu","bo_changwu", []),
 ("z_changwu_b",0,"changwu_b","bo_changwu_b", []),
 ("z_changwu_c",0,"changwu_c","bo_changwu_c", []), 
 ("z_changwu_d",0,"changwu_d","bo_changwu_d", []),
 ("z_dian",0,"dian","bo_dian", []),
 ("z_dian_b",0,"dian_b","bo_dian_b", []),
 ("z_dian_c",0,"dian_c","bo_dian_c", []),
 ("z_dian_d",0,"dian_d","bo_dian_d", []),
 ("z_wfdian",0,"wfdian","bo_wfdian", []), 
 ("z_nmdian",0,"nmdian","bo_nmdian", []),
 ("z_nmdian_b",0,"nmdian_b","bo_nmdian_b", []), 
 ("z_nmdian_c",0,"nmdian_c","bo_nmdian_c", []),
 ("z_nmdian_d",0,"nmdian_d","bo_nmdian_d", []), 
 ("z_fanpeng",0,"fanpeng","bo_fanpeng", []),
 ("z_fanpdian",0,"fandian","bo_fandian", []), 
 ("z_yupu",0,"yupu","bo_yupu", []),
 ("z_caidian",0,"caidian","bo_caidian", []), 
 ("z_taoqidian",0,"taoqidian","bo_taoqidian", []),
 ("z_dou_gate1",0,"dou_gate1","bo_dou_gate1", []),
 ("z_dou_gate1y",0,"dou_gate1y","bo_dou_gate1y", []), 
 ("z_dou_hei1_s",0,"dou_hei1_s","bo_dou_hei1_s", []),
 ("z_dou_ishigaki_k_large",0,"dou_ishigaki_k_large","bo_dou_ishigaki_k_large", []),
 ("z_dou_ishigaki_k_small",0,"dou_ishigaki_k_small","bo_dou_ishigaki_k_small", []),
 ("z_dou_ishigaki_s_large",0,"dou_ishigaki_s_large","bo_dou_ishigaki_s_large", []),
 ("z_dou_ishigaki_s_small",0,"dou_ishigaki_s_small","bo_dou_ishigaki_s_small", []),
 ("z_dou_ishigaki_t_large",0,"dou_ishigaki_t_large","bo_dou_ishigaki_t_large", []),
 ("z_dou_ishigaki_t_small",0,"dou_ishigaki_t_small","bo_dou_ishigaki_t_small", []),
 ("z_dou_morituti_k_large",0,"dou_morituti_k_large","bo_dou_morituti_k_large", []),
 ("z_dou_morituti_k_small",0,"dou_morituti_k_small","bo_dou_morituti_k_small", []),
 ("z_dou_morituti_s_large",0,"dou_morituti_s_large","bo_dou_morituti_s_large", []),
 ("z_dou_morituti_s_small",0,"dou_morituti_s_small","bo_dou_morituti_s_small", []),
 ("z_dou_morituti_t_large",0,"dou_morituti_t_large","bo_dou_morituti_t_large", []),
 ("z_dou_morituti_t_small",0,"dou_morituti_t_small","bo_dou_morituti_t_small", []),
 ("z_dou_bridge1",0,"dou_bridge1","bo_dou_bridge1", []), 
 ("z_dou_saku_k",0,"dou_saku_k","bo_dou_saku_k", []),
 ("z_dou_saku_s",0,"dou_saku_s","bo_dou_saku_s", []),
 ("z_dou_saku_t",0,"dou_saku_t","bo_dou_saku_t", []),
 ("z_dou_hei_long",0,"dou_hei_long","bo_dou_hei_long", []),
 ("z_dou_hei_machi_long",0,"dou_hei_machi_long","bo_dou_hei_machi_long", []),
 ("z_dou_hei_machi",0,"dou_hei_machi","bo_dou_hei_machi", []),
 ("z_japanese_village_house",0,"japanese_village_house","bo_japanese_village_house", []),
 ("z_japanese_teahouse",0,"japanese_teahouse","bo_japanese_teahouse", []),
 ("z_qibu",0,"qibu","bo_qibu", []),
 ("z_qingzhou",0,"qingzhou","bo_qingzhou", []), 
 ("z_jianta",0,"jianta","bo_jianta", []),
 ("z_guardtower",0,"guardtower","bo_guardtower", []), 
 ("z_juma",0,"juma","bo_juma", []), 
 ("z_shanlan1",0,"shanlan1","bo_shanlan1", []), 
 ("z_shanlan2",0,"shanlan2","bo_shanlan2", []), 
 ("z_shanlan3",0,"shanlan3","bo_shanlan3", []), 
 ("z_shanlan4",0,"shanlan4","bo_shanlan4", []),
 ("z_shanlan5",0,"shanlan5","bo_shanlan5", []), 
 ("z_shanlan6",0,"shanlan6","bo_shanlan6", []),
 ("z_qiang1",0,"qiang1","bo_qiang1", []), 
 ("z_qiang2",0,"qiang2","bo_qiang2", []), 
 ("z_qiang3",0,"qiang3","bo_qiang3", []), 
 ("z_qiang4",0,"qiang4","bo_qiang4", []),
 ("z_qiang5",0,"qiang5","bo_qiang5", []),
 ("z_qiao",0,"qiao","bo_qiao", []),  
 ("z_dedao",0,"dedao","bo_dedao", []),  
 ("z_menjiaqiang",0,"menjiaqiang","bo_menjiaqiang", []),
 ("z_beitiao",0,"beitiao","bo_beitiao", []),
 ("z_mumen",0,"mumen","bo_mumen", []),
 ("z_men2",0,"men2","bo_men2", []),
 ("z_men1",0,"men1","bo_men1", []),
 ("z_dizuo",0,"dizuo","bo_dizuo", []),   
 ("z_yagura_corner",0,"yagura_corner","bo_yagura_corner", []),
 ("z_yagura_monn",0,"yagura_monn","bo_yagura_monn", []), 
 ("z_yagura_corner_small",0,"yagura_corner_small","bo_yagura_corner_small", []), 
 ("z_japanese_village_house_2",0,"japanese_village_house_2","bo_japanese_village_house", []),  
 ("z_japanese_defencing_wall",0,"japanese_defencing_wall","bo_japanese_defencing_wall", []),   
 ("z_yagura_tower",0,"yagura_tower","bo_yagura_tower", []),   
 ("z_interior_01",0,"interior_01","bo_interior_01", []), 
 ("z_yagura_wall",0,"yagura_wall","bo_yagura_wall", []), 
 ("z_yagura_n_1",0,"yagura_n_1","bo_yagura_n_1", []), 
 ("z_yagura_n_2",0,"yagura_n_2","bo_yagura_n_2", []),
 ("z_yagura_n_3",0,"yagura_n_3","bo_yagura_n_3", []),  
 ("z_yagura_extension_1",0,"yagura_extension_1","bo_yagura_extension_1", []),  
 ("z_yagura_n_extension_b",0,"yagura_n_extension_b","bo_yagura_n_extension_b", []),  
 ("z_yagura_n_qianniao",0,"yagura_n_qianniao","bo_yagura_n_qianniao", []),  
 ("z_yagura_n_juanpeng",0,"yagura_n_juanpeng","bo_yagura_n_juanpeng", []),  
 ("z_yagura_qianniao2",0,"yagura_qianniao2","bo_yagura_qianniao2", []),
 ("z_yagura_twostories",0," yagura_twostories","bo_yagura_twostories", []), 
 ("z_50_hei",0,"hei","bo_hei", []),
 ("z_yagura_corner_new",0," yagura_corner_new","bo_yagura_corner_new", []), 
 ("z_daochang",0," daochang","bo_daochang", []),
 ("z_gate2",0,"gate2","bo_gate2", []),
 ("z_gate1",0,"gate1","bo_gate1", []), 
 ("z_opengate",0,"opengate","bo_opengate", []), 
 ("z_qingzhou2",0,"qingzhou2","bo_qingzhou2", []), 
 ("z_XYshanlan",0,"XYshanlan","bo_XYshanlan", []),  
 ("z_zhen1",0,"zhen1","bo_zhen1", []),
 
 ("z_tree_sakura",0,"tree_sakura_1","bo_tree_sakura_1", []),
 ("z_tree_acher",0,"tree_acer_1","bo_tree_acher_1", []),  
 ("z_bamboo_1",0,"bamboo_1","bo_bamboo_1", []), 
 ("z_bamboo_2",0,"bamboo_2","bo_bamboo_2", []),
 ("z_bamboo_3",0,"bamboo_3","bo_bamboo_3", []),  
 ("z_fall_sakura_flowers",0,"0","0",
   [
   (ti_on_scene_prop_init,
    [
     (particle_system_add_new, "psys_fall_sakura_flower"),
    ]),
   ]), 
...
("jap_arch_01", 0, "jap_arch_01", "bo_jap_arch_01", []),
("jap_arch_02", 0, "jap_arch_02", "bo_jap_arch_02", []),
("jap_arch_03", 0, "jap_arch_03", "bo_jap_arch_03", []),
("jap_bridge_wooden", 0, "jap_bridge_wooden", "bo_jap_bridge_wooden", []),
("jap_external_extras_01", 0, "jap_external_extras_01", "0", []),
("jap_external_extras_02", 0, "jap_external_extras_02", "bo_jap_external_extras_02", []),
("jap_external_extras_03", 0, "jap_external_extras_03", "bo_jap_external_extras_03", []),
("jap_fishing_boat", 0, "jap_fishing_boat", "0", []),
("jap_house_01", 0, "jap_house_01", "bo_jap_house_01", []),
("jap_house_02", 0, "jap_house_02", "bo_jap_house_02", []),
("jap_house_03", 0, "jap_house_03", "bo_jap_house_03", []),
("jap_house_04", 0, "jap_house_04", "bo_jap_house_04", []),
("jap_house_05", 0, "jap_house_05", "bo_jap_house_05", []),
("jap_house_06", 0, "jap_house_06", "bo_jap_house_06", []),
("jap_house_07", 0, "jap_house_07", "bo_jap_house_07", []),
("jap_house_08", 0, "jap_house_08", "bo_jap_house_08", []),
("jap_house_09", 0, "jap_house_09", "bo_jap_house_09", []),
("jap_house_10", 0, "jap_house_10", "bo_jap_house_10", []),
("jap_house_11", 0, "jap_house_11", "bo_jap_house_11", []),
("jap_house_12", 0, "jap_house_12", "bo_jap_house_12", []),
("jap_house_13", 0, "jap_house_13", "bo_jap_house_13", []),
("jap_house_14", 0, "jap_house_14", "bo_jap_house_14", []),
("jap_house_15", 0, "jap_house_15", "bo_jap_house_15", []),
("jap_house_stairs_01", 0, "jap_house_stairs_01", "bo_jap_house_stairs_01", []),
("jap_house_stairs_02", 0, "jap_house_stairs_02", "bo_jap_house_stairs_02", []),
("jap_internal_extras_01", 0, "jap_internal_extras_01", "bo_jap_internal_extras_01", []),
("jap_internal_extras_02", 0, "jap_internal_extras_02", "bo_jap_internal_extras_02", []),
("jap_internal_extras_03", 0, "jap_internal_extras_03", "bo_jap_internal_extras_03", []),
("jap_internal_extras_04", 0, "jap_internal_extras_04", "bo_jap_internal_extras_04", []),
("jap_internal_extras_05", 0, "jap_internal_extras_05", "bo_jap_internal_extras_05", []),
("jap_internal_extras_06", 0, "jap_internal_extras_06", "0", []),
("jap_internal_extras_07", 0, "jap_internal_extras_07", "0", []),
("jap_internal_extras_08", 0, "jap_internal_extras_08", "0", []),
("jap_internal_extras_09", 0, "jap_internal_extras_09", "bo_jap_internal_extras_09", []),
("jap_internal_extras_10", 0, "jap_internal_extras_10", "bo_jap_internal_extras_10", []),
("jap_lantern_01", 0, "jap_lantern_01", "0", []),
("jap_lantern_02", 0, "jap_lantern_02", "0", []),
("jap_lantern_03", 0, "jap_lantern_03", "0", []),
("jap_lantern_04", 0, "jap_lantern_04", "0", []),
("jap_lantern_05", 0, "jap_lantern_05", "0", []),
("jap_lantern_06", 0, "jap_lantern_06", "0", []),
("jap_lantern_07", 0, "jap_lantern_07", "0", []),
("jap_lantern_08", 0, "jap_lantern_08", "0", []),
("jap_lantern_09", 0, "jap_lantern_09", "0", []),
("jap_lantern_10", 0, "jap_lantern_10", "0", []),
("jap_lantern_11", 0, "jap_lantern_11", "0", []),
("jap_lantern_12", 0, "jap_lantern_12", "0", []),
("jap_lantern_13", 0, "jap_lantern_13", "0", []),
("jap_shrine_01", 0, "jap_shrine_01", "bo_jap_shrine_01", []),
("jap_shrine_02", 0, "jap_shrine_02", "bo_jap_shrine_02", []),
("jap_shrine_03", 0, "jap_shrine_03", "bo_jap_shrine_03", []),
("jap_shrine_04", 0, "jap_shrine_04", "bo_jap_shrine_04", []),
("jap_sign_01", 0, "jap_sign_01", "bo_jap_sign_01", []),
("jap_sign_02", 0, "jap_sign_02", "bo_jap_sign_02", []),
("jap_sign_03", 0, "jap_sign_03", "bo_jap_sign_03", []),
("jap_sign_04", 0, "jap_sign_04", "bo_jap_sign_04", []),
("tibet_external_extras_01", 0, "tibet_external_extras_01", "bo_tibet_external_extras_01", []),
("tibet_external_extras_02", 0, "tibet_external_extras_02", "bo_tibet_external_extras_02", []),
("tibet_external_extras_03", 0, "tibet_external_extras_03", "bo_tibet_external_extras_03", []),
("tibet_external_extras_04", 0, "tibet_external_extras_04", "bo_tibet_external_extras_04", []),
("tibet_external_extras_05", 0, "tibet_external_extras_05", "0", []),
("tibet_external_extras_06", 0, "tibet_external_extras_06", "0", []),
("tibet_external_extras_07", 0, "tibet_external_extras_07", "0", []),
("tibet_house_01", 0, "tibet_house_01", "bo_tibet_house_01", []),
("tibet_house_02", 0, "tibet_house_02", "bo_tibet_house_02", []),
("tibet_large_building", 0, "tibet_large_building", "bo_tibet_large_building", []),
("tibet_pagoda_01", 0, "tibet_pagoda_01", "bo_tibet_pagoda_01", []),
("tibet_pagoda_02", 0, "tibet_pagoda_02", "bo_tibet_pagoda_02", []),
("tibet_shrine_01", 0, "tibet_shrine_01", "bo_tibet_shrine_01", []),
("tibet_shrine_02", 0, "tibet_shrine_02", "bo_tibet_shrine_02", []),
("tibet_shrine_03", 0, "tibet_shrine_03", "bo_tibet_shrine_03", []),
("tibet_temple", 0, "tibet_temple", "bo_tibet_temple", []),
...
("gekokujo_c4_gate1_simple", 0, "gekokujo_c4_gate1_simple", "bo_gekokujo_c4_gate1_simple", []),
...
("zg_taijie", 0, "G_taijie", "bo_G_taijie", []),
("zg_shoutou", 0, "G_shoutou", "none", []),
("zg_shoutou2", 0, "G_shoutou2", "none", []),
("zg_qqm", 0, "G_qqm", "bo_G_qqm", []),
("zg_qqg", 0, "G_qqg", "bo_G_qqg", []),
("zg_muzhu", 0, "G_muzhu", "bo_G_muzhu", []),
("zg_menkan", 0, "G_menkan", "bo_G_menkan", []),
("zg_guangchang", 0, "G_guangchang", "bo_G_guangchang", []),
("zg_guangchang2", 0, "G_guangchang2", "bo_G_guangchang2", []),
("zg_gq", 0, "G_gq", "bo_G_gq", []),
("zg_gq2", 0, "G_gq2", "bo_G_gq2", []),
("zg_gongweilan", 0, "G_gongweilan", "bo_G_gongweilan", []),
("zg_gongwei", 0, "G_gongwei", "none", []),
("zg_gongqiang", 0, "G_gongqiang", "bo_G_gongqiang", []),
("zg_diji", 0, "G_diji", "bo_G_diji", []),
("zg_cefang", 0, "G_cefang", "bo_G_cefang", []),
