  ...
  (
    ...
    [
      ...
      [
        ...
        (troop_add_item, "$g_player_troop","itm_british_rifle_ranker",0),
        (troop_add_item, "$g_player_troop","itm_ming_boot",0),
        (troop_add_item, "$g_player_troop","itm_british_rifle_shako_ranker",0),
