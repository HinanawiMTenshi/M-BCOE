...
slot_drop_bomb_y  = 40
slot_drop_bomb_z  = 41
slot_drop_bomb_ignite_time = 42
slot_bomb_is_active = 43
slot_agent_shoot_time_ticker = 44
slot_agent_horse = 45
slot_agent_roll_time = 46
slot_agent_shield_time = 47
slot_sanyanchong_time = 48
slot_sanyanchong_fire = 49
slot_agent_on_fire = 50
slot_scene_prop_width = 3
slot_scene_prop_attached_to_agent = 2
########################################################
##  FACTION SLOTS          #############################
########################################################
...
mm_destructible_doors_begin  = "spr_door_destructible"
mm_destructible_doors_end    = "spr_mm_restroom_door"
...
cannon_ammo_type_new_rocket     = 6
cannon_ammo_types_begin     = cannon_ammo_type_round
cannon_ammo_types_end       = 7
...
player_action_rolling_f2 = 19
player_action_rolling_r2 = 21
player_action_rolling_b2 = 23
player_action_rolling_l2 = 24
#custom_keys: end
player_action_misc_item_drinking = 19
player_action_custom_order_menu_interact = 20
player_action_suicide_m = 21
player_action_fuse = 22
player_action_exp = 23
player_action_suicide_j = 24
player_action_suicide_s = 25
player_action_set_speed_zero = 26
player_action_call_horse = 27
player_actions_begin        = player_action_voice
player_action_rolling_f = 28
player_action_rolling_r = 29
player_action_rolling_b = 30
player_action_rolling_l = 31
player_action_st2 = 32
player_action_st = 33
me_agent_shield_taunt = 34
player_action_suicide_jin = 35
player_action_sanyanchong = 36
player_action_wuqiang = 37
player_action_spear = 38
player_actions_end          = 39
...
voice_type_comm_inf           =12
voice_type_comm_skr           =13
voice_type_comm_cav           =14
voice_type_comm_unit          =15
voice_type_comm_every         =16
voice_type_comm_mount         =17
voice_type_comm_fire_left     =18
voice_type_comm_fire_middle    =19
voice_type_comm_fire_right    =20
voice_type_comm_dismount      =21
voice_type_comm_closer      =22
voice_type_comm_spread      =23
voice_type_comm_any      =24
voice_type_comm_1      =25
voice_type_comm_2      =26
voice_type_comm_3      =27
voice_type_comm_4      =28
voice_type_comm_5      =29
voice_type_comm_hold_fire  =30
voice_type_comm_melee      =31
voice_type_comm_ranged_weapons = 32
voice_type_comm_retreat        =33
voice_type_comm_stand_ground  =34
voice_type_comm_blunt  =35
...
# for change bg music only
track_start			= "track_strauss_radetzky_march"
track_name_start 	= "str_soundtrack_name_2"

# for commander mode only
troop_multiplayer_begin = "trp_british_infantry_ai"
troop_multiplayer_player_troop_begin = "trp_british_infantry"
troop_multiplayer_end = "trp_multiplayer_end"

graphic_enhancement_version = 15
graphic_enhancement_version_sub = 2

# agent slots and troop slots
#slot_agent_map_overlay_id_larger_map = 45 # icon


slot_agent_map_overlay_id_v15					= 38
slot_agent_hp_bar 								= slot_agent_map_overlay_id_v15 +1
slot_agent_hp_bar_bg							= slot_agent_hp_bar +1
slot_agent_hp_bar_name							= slot_agent_hp_bar_bg +1
slot_agent_underwater_time_client							= slot_agent_hp_bar_name +1
slot_agent_underwater_now_client							= slot_agent_underwater_time_client +1

slot_agent_cb_name_and_troop 					= slot_agent_underwater_now_client +1

#slot_troop_ai_lead_troop    = 23
slot_troop_type			    = 23
slot_player_troop_cb_check = slot_player_bot_order + 1 

slot_troop_name_for_tab_list		= slot_troop_type +1
slot_troop_ai_lead_troop = slot_troop_name_for_tab_list+1
...
color_cav			= color_cyan
color_inf			= 0x42f489
color_linf			= 0xe542f4
color_other			= 0xf49b41
color_arty			= 0xf1f441
