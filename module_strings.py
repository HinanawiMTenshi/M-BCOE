...
# Strings before this point are hardwired.  
  ...
  ("call_horse", "You whistle for your horse."),
  ("horse_dead", "You horse is killed in battle."),
  
  # MM
  ("kingdom_1_adjective",                     "Great Ming Empire"),
  ("kingdom_2_adjective",                     "Edoshigaku Japan"),
  ("kingdom_3_adjective",                     "House of Habsburg"),
  ("kingdom_4_adjective",                     "Manchu Jin Empire"),
  ("kingdom_5_adjective",                     "Russian Empire"),
  ("kingdom_6_adjective",                     "Ottoman Empire"),
  

  ("credits_1", "Mount&Blade Warband: Napoleonic Wars Copyright 2008-2012 Taleworlds Entertainment"),
  ("credits_2", "GreatMing Regiment"),
  ("credits_3", "Game design:JOJO, Tiepao, Zhengde,Guchen,Viking,lutiya"),
  ("credits_4", "Programming:Zhengde,mali,Guchen"),
  ("credits_5", "Voice acting:Hongzhi,WilCV"),
  ("credits_6", "Taleworlds Entertainment"),
  ("credits_7", "Founder:Zhengde"),
  ("credits_8", "Scene: lutiya,111"),
  ("credits_9", "Muisc Searing:tiepao,Zhengde"),
  ("credits_10", "Concept Art:FMH,Viking"),
  ("credits_11", "Director Of Communications:Zhengde"),
  ("credits_12", "Special thank: mali"),
  ("credits_13", "Animation: Viking"),
  ("credits_14","Model searching: Lutiya,guchen,JOJO"),
  ("credits_15", "Unused"),
...
#multiplayer game type names
  ...
  #Faction selection
  ("britain_name", "Great Ming Empire"),
  ("france_name", "Edoshigaku Japan"),
  ("prussia_name", "House of Habsburg"),
  ("russia_name", "Manchu Jin Empire"),
  ("austria_name", "Russian Empire"),
  ("rhine_name", "Ottoman Empire"),
  ...
  ("cannon", "Cannon"),
  ("commander", "Commander"),
  ("qing_women_salve", "Qing women Salve"),
  ("ming_medic", "Ming medic"),
  ("monk_rebel", "Monk Rebel"),
  ("aztec", "Aztec Warrior"),
  ...
  ("sail_brit","Ming Marine"),#hotfix
  ("sail_fren","Mori ship crew"),  
  #Music Tracks
...
("grenade_message", "You have a grenade, press X to ignite the grenade, It will explode in 10 seconds after ignition."),
("suicide_player", "Suicide"),#patch1115 58/4
("s2_suicide", "{s2} has committed suicide."),#patch1115 58/5
("ziwen", "{s2} cutted his own throat."),#suicide for Ming
("qisi", "{s2} die of his anger."),#suicide for Jin
("seppuku", "{s2} seppuku."),#suicide for Japan
("pistol_suicide", "{s2} shot his own head."),#suicide for Spain
...
("record_kill", "Last time you killed: ^{s14}"),
("record_killed_by", "Last time who killed you:^{s15}"),
("record_tk", "[Teamkill]"),

#respawn counter
("respawning_counter", "{reg0}"),
("respawning_text", "Respawning.."),#

("in_walk", "Walking"),#
("in_crouch", "Crouching"),#

# module extra options
("mod_options","MOD More Options"),
("display_latency", "Display Latency & Server Info					"), #
("display_team_score", "Display Team score							"),#
("display_time_counter", "Display Round Time Counter				"),#
("display_spec_hp", "Display percentage HPs					        "), # default On
("display_kd_info", "Display Kill/Death Info						"),#
("display_ally_name", "Display Ally Name & HP Bar(Only for player)	"),#
("display_minimap", "Display Commander Mode Minimap					"),#check box
#("display_btmap", "View the Commander Mode Battle Map				"),# button
("display_cb_troop_ratio", "Display Commander Battle Troop Ratio	"),# new one 10/22
("play_track_menu", "Change Background Music						"),#
("change_weather", 	"Change Weather									"),#15.2
("display_hint_others", "\
^- Key 'V' clicked down to gain a 1.2x zoom scope.\
^- Key 'Left Ctrl' to view ally's name, HP.\
^- Key 'M' to open minimap.^(Twice click can open larger map in Commander Mode)\
^- Reminded: Troop name in Map/Stats Chart(Tab) may be different from^the server's own modification.\
"),#

("display_not_av_func", "This is not available in current game mode."),#

#kill death info
("KD_kill_info", "You killed:^ {s10} "),#
("KD_death_info", "Killed by:^{s11}"),#
("KD_selected_troop", "Selected Troop:^ {s12}({s13})"),#

("KD_suicide_info", "Suicide"),
("KD_fk_warning", "[Teamkill]"),

#bonus texts 
("damage_bonus_text", 	"Melee Fighting Damage"),
("accuracy_bonus_text", "Aiming Accuracy"),
("speed_bonus_text", 	"Running Speed"),
("reload_bonus_text", 	"Reloading Speed"),
("use_bonus_text", 		"Reload Cannon Speed^Pick shots speed"),
("general_bonus_text", 	"All bonus"),
("bounus_ratio",		"+{reg50}% "),

# player stats 
("HP", "HP"),
("K_D", "K/D"),
("K_D_record", "{reg30}.{reg31}{reg32}"),
("K_D_neg_record", "-{reg30}.{reg31}{reg32}"),
#("neg_K_D_record", "{reg30}.{reg31}{reg32}"),
("server_info", "Server: {s60}"),
("current_player_count", "Current Player(s):{reg27}"),
("current_game_mode", "Current Game Mode:{s5}"),
("current_map", "Current Map:{s24}"),
("troop_id", "Troop"),#v15.2

("reg55_percentage", "{reg55}%"),
("no_bot_show_in_tab_prsnt","No bot"),
# which replaced the string "bot(1 agent)" where has no bot alive already.
("reg13_alive","{reg13} alive"),
# v15 , replace HP by bots alive per team in commander battle
("cb_bot_alive", "Status"),

# commander battle troop type
("cb_inf", "Inf"),
("cb_inf_l", "Li.Inf"),
("cb_cav", "Cav"),
("cb_art", "Arty"),
...
#commander
("troop_type_willington", "Willington"),
("troop_type_napoleon", "Napoleon"),
("troop_type_blucher", "Blucher"),
("troop_type_kutuzov", "Kutuzov"),
("troop_type_phillip", "Schwarzenberg"),
("troop_type_fa", "Friedrich August"),
#some shorten name for troop
("troop_type_br1", "33rd Inf"),
("troop_type_br2", "5th German Inf"),
("troop_type_br3", "42nd Highlander"),
("troop_type_br4", "Coldstream Inf"),
("troop_type_br5", "51st Light Inf"),
("troop_type_br6", "95th Riflemen"),
("troop_type_br7", "Hussar"),
("troop_type_br8", "Light Dragoon"),
("troop_type_br9", "Inniskilling Dragoon"),
("troop_type_br10", "Horse Guard"),
("troop_type_br11", "Artillery"),
("troop_type_br12", "Rocketeer"),

("troop_type_fr1", "45e Inf"),
("troop_type_fr2", "84e Inf"),
("troop_type_fr3", "Vistule Inf"),
("troop_type_fr4", "1er Grenadiers"),
("troop_type_fr5", "15e Voltigeur"),
("troop_type_fr6", "Hussar"),
("troop_type_fr7", "Lancer"),
("troop_type_fr8", "Dragoon"),
("troop_type_fr9", "Cuirassiers"),
("troop_type_fr10", "Carabiniers"),
("troop_type_fr11", "Horse Grenadier"),
("troop_type_fr12", "Artillery"),

("troop_type_pr1", "Brandenburg Inf"),
("troop_type_pr2", "Rhen Inf"),
("troop_type_pr3", "Landwehr"),
("troop_type_pr4", "Freikorps"),
("troop_type_pr5", "Foot Guard"),
("troop_type_pr6", "Jaeger"),
("troop_type_pr7", "Dragoon"),
("troop_type_pr8", "Hussar"),
("troop_type_pr9", "Lancer"),
("troop_type_pr10", "Cuirassier"),
("troop_type_pr11", "Artillery"),

("troop_type_ru1", "Militia"),
("troop_type_ru2", "Simbirskiy"),
("troop_type_ru3", "Pavlovskiy"),
("troop_type_ru4", "Preobrazhenskiy"),
("troop_type_ru5", "21-y Yegerskiy"),
("troop_type_ru6", "Hussar"),
("troop_type_ru7", "Lithuanian Lancer"),
("troop_type_ru8", "Cossack Lancer"),
("troop_type_ru9", "Dragoon"),
("troop_type_ru10", "Guard Cavalry"),
("troop_type_ru11", "Artillery"),

("troop_type_au1", "Nr. 14 Inf"),
("troop_type_au2", "Nr. 62 Inf"),
("troop_type_au3", "Nr. 3 Grenzer"),
("troop_type_au4", "Grenadier"),
("troop_type_au5", "Jaeger"),
("troop_type_au6", "Hussar"),
("troop_type_au7", "Lancer"),
("troop_type_au8", "Chevauleger"),
("troop_type_au9", "Dragoon"),
("troop_type_au10", "Cuirassier"),
("troop_type_au11", "Artillery"),

("troop_type_rh1", "Bavaria Inf"),
("troop_type_rh2", "Wurttemberg Inf"),
("troop_type_rh3", "Saxon Inf"),
("troop_type_rh4", "Grenadier"),
("troop_type_rh5", "Grenadier Guard"),
("troop_type_rh6", "Light Inf"),
("troop_type_rh7", "Rifleman"),
("troop_type_rh8", "Mounted Jaeger"),
("troop_type_rh9", "Saxon Uhlan"),
("troop_type_rh10", "Light Dragoon"),
("troop_type_rh11", "Cuirassier"),
("troop_type_rh12", "Horse Guard"),
("troop_type_rh13", "Artillery"),

#large size battle map,display name and troops
#use center justify
("player_name_troop", "{s51}^{s50}"),

("graphic_enhancement_version", "Enhancement v{reg15}.{reg16}"),

#track name
#("soundtrack_name_1","{!}Unused"), # main theme cancelled
("soundtrack_name_2","Johann_Strauss - Radetzky March"),
("soundtrack_name_3","Beethoven - Symphony No.9 Movement 4"),
("soundtrack_name_4","Franz Schubert - Marche Militaire"),
("soundtrack_name_5","Mozart - Great Mass Gloria"),
("soundtrack_name_6","Bizet - Carmen Toreador"),
("soundtrack_name_7","Wagner - Ride of The Valkyries"),
("soundtrack_name_8","Beethoven - Symphony No.5 Movement 1"),
("soundtrack_name_9","Dvorak - Symphony No.9 Movement 4"),
("soundtrack_name_10","Tchaikovsky - Overture 1812"),
("soundtrack_name_11","Bach - Cello Suite 1"),
("soundtrack_name_12","Elgar - Pomp_And_Circumstance_March_No.1"),
("soundtrack_name_13","Handel - Queen of Sheba"),# Correct this name v15
("soundtrack_name_14","Handel - Hallelujah Chorus From The Massiah"),
("soundtrack_name_15","Vivaldi - Summer Presto"),
("soundtrack_name_16","William_Boyce - Sinfonia No.1"),
("soundtrack_name_17","Mazurek_Dabrowskiego - Polish National Anthem"),
("soundtrack_name_18","Grieg - Peer Gynt - Overture"),
("soundtrack_name_19","Bach - Orchestral Suite No.3 Air"),
("soundtrack_name_20","Geminiani - Concerto_Grosso"),
("soundtrack_name_21","Grieg - Peer_Gynt - In The Hall Of The Mountain King"),
("soundtrack_name_22","Liszt - Les_Preludes"),
("soundtrack_name_23","Chopin - Polonaise_Military"),
("soundtrack_name_24","Bizet - Carmen_Aragonaise"),
("soundtrack_name_25","Hummel - Rondo"),
("soundtrack_name_26","Bach - Concerto For Two Violins First Movement"),
("soundtrack_name_27","Boccherini - Minuet"),
("soundtrack_name_28","Brahms - Hungarian Dance 5"),
("soundtrack_name_29","Mozart - Eine Kleine Nachtmusik Allegro"),
("soundtrack_name_30","Strausss - Blue Danube Waltz"),
("soundtrack_name_31","Rimsky_Korsakov - The Flight Of The Bumble Bee"),
("soundtrack_name_32","Bach - Gavotte"),
("soundtrack_name_33","Vivaldi - Spring Allegro"),
("soundtrack_name_34","Vivaldi - Spring Allegro_2"),
("soundtrack_name_35","Vivaldi - Autumn Allegro"),
("soundtrack_name_36","Vivaldi - Summer Allegro Adagio"),
("soundtrack_name_37","Vivaldi - Winter Presto"),
("soundtrack_name_38","Vivaldi - Winter Allegro"),
("soundtrack_name_39","Vivaldi - Concerto 10 Allegro II"),
("soundtrack_name_40","Vivaldi - Concerto Flute Violin Continuo Allegro"),
("soundtrack_name_41","Vivaldi - Concerto Grosso 8 Allegro"),
("soundtrack_name_42","Mendelsshon - Wedding March Recessional"),
("soundtrack_name_43","Bach - Brandenburg Concerto Movement 1"),
("soundtrack_name_44","Pachelbel - Canon"),
("soundtrack_name_45","Saint_Saens - Danse Macabre"),
("soundtrack_name_46","Rossini - William Tell Overture"),
# new added v15
("soundtrack_name_47","French National Anthem - Le Chant du D¨¦part"),
("soundtrack_name_48","British National Anthem - God Save The King"),
("soundtrack_name_49","Austrian National Anthem - Kaiserhymnen"),
("soundtrack_name_50","Russian National Anthem - Let The Thunder of Victory Rumble!"),
("soundtrack_name_51","Russian Military March - March of the Preobrazhensky Regiment"),
("soundtrack_name_52","The British Grenadier March"),
("soundtrack_name_end", "{!}soundtrack name end"),
...
("elite_wave_hint", "Beware: Enemies' commander is arriving, defeat them!"),
("respawn_next", "You will be respawn next round"),
("respawn_this", "You will be respawn this round"),
("round1", "Enemies wave is coming in 10 seconds"),
("rounds", "You defeated the enemies! Next enemies wave is coming in 30 seconds"),
("boss_round", "Enemies' commander is coming on the way! Be careful!"),
